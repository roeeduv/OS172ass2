...
writetest1(void)
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     77d:	53                   	push   %ebx
     77e:	68 7b 4b 00 00       	push   $0x4b7b
     783:	ff 35 a0 71 00 00    	pushl  0x71a0
    ...
    if(((int*)buf)[0] != n){
     ...
     793:	50                   	push   %eax
     794:	53                   	push   %ebx
     795:	68 cc 59 00 00       	push   $0x59cc
     79a:	ff 35 a0 71 00 00    	pushl  0x71a0
     ...
     7ad:	50                   	push   %eax
     7ae:	68 cf 4b 00 00       	push   $0x4bcf
     7b3:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     7cb:	68 b2 4b 00 00       	push   $0x4bb2
     7d0:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
     ...
     7e3:	68 99 4b 00 00       	push   $0x4b99
     7e8:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
     ...
     7fb:	68 61 4b 00 00       	push   $0x4b61
     800:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     813:	68 df 4b 00 00       	push   $0x4bdf
     818:	ff 35 a0 71 00 00    	pushl  0x71a0
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 ec 59 00 00       	push   $0x59ec
     841:	ff 35 a0 71 00 00    	pushl  0x71a0
     847:	e8 c4 31 00 00       	call   3a10 <printf>

  name[0] = 'a';
     84c:	c6 05 80 b9 00 00 61 	movb   $0x61,0xb980
  name[2] = '\0';
     853:	c6 05 82 b9 00 00 00 	movb   $0x0,0xb982
  ...
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     863:	88 1d 81 b9 00 00    	mov    %bl,0xb981
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 80 b9 00 00       	push   $0xb980
  ...
  name[0] = 'a';
     88b:	c6 05 80 b9 00 00 61 	movb   $0x61,0xb980
  name[2] = '\0';
     892:	c6 05 82 b9 00 00 00 	movb   $0x0,0xb982
  ...
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     8a3:	88 1d 81 b9 00 00    	mov    %bl,0xb981
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 80 b9 00 00       	push   $0xb980
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 14 5a 00 00       	push   $0x5a14
     8c6:	ff 35 a0 71 00 00    	pushl  0x71a0
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 00 4c 00 00       	push   $0x4c00
     8eb:	ff 35 a0 71 00 00    	pushl  0x71a0
     8f1:	e8 1a 31 00 00       	call   3a10 <printf>

  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 0c 4c 00 00 	movl   $0x4c0c,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     90c:	68 0c 4c 00 00       	push   $0x4c0c
  ...
  if(chdir("..") < 0){
     ...
     924:	68 b1 51 00 00       	push   $0x51b1
  ...
  if(unlink("dir0") < 0){
     ...
     938:	68 0c 4c 00 00       	push   $0x4c0c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     94c:	68 49 4c 00 00       	push   $0x4c49
     951:	ff 35 a0 71 00 00    	pushl  0x71a0
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
     961:	50                   	push   %eax
     962:	50                   	push   %eax
     963:	68 3c 49 00 00       	push   $0x493c
     968:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 35 4c 00 00       	push   $0x4c35
     97f:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 24 4c 00 00       	push   $0x4c24
     996:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 11 4c 00 00       	push   $0x4c11
     9ad:	ff 35 a0 71 00 00    	pushl  0x71a0
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 58 4c 00 00       	push   $0x4c58
     9cb:	ff 35 a0 71 00 00    	pushl  0x71a0
     9d1:	e8 3a 30 00 00       	call   3a10 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 a4 71 00 00       	push   $0x71a4
     9dd:	68 21 4a 00 00       	push   $0x4a21
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 63 4c 00 00       	push   $0x4c63
     9f7:	ff 35 a0 71 00 00    	pushl  0x71a0
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 80 99 00 00       	push   $0x9980
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b 80 99 00 00 	cmp    %bl,0x9980(%ebx,%ecx,1)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     aaa:	68 92 4c 00 00       	push   $0x4c92
     aaf:	6a 01                	push   $0x1
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     ae0:	88 9c 18 80 99 00 00 	mov    %bl,0x9980(%eax,%ebx,1)
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     af8:	68 80 99 00 00       	push   $0x9980
  ...
  printf(1, "pipe1 ok\n");
     b35:	58                   	pop    %eax
     b36:	5a                   	pop    %edx
     b37:	68 b7 4c 00 00       	push   $0x4cb7
     b3c:	6a 01                	push   $0x1
    ...
    if(total != 5 * 1033){
     ...
     b51:	68 a0 4c 00 00       	push   $0x4ca0
     b56:	6a 01                	push   $0x1
     ...
     b5d:	e8 40 2d 00 00       	call   38a2 <exit>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     ...
     b65:	68 75 4c 00 00       	push   $0x4c75
     b6a:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     ...
     b79:	68 c1 4c 00 00       	push   $0x4cc1
     b7e:	6a 01                	push   $0x1
    ...
    for(n = 0; n < 5; n++){
     ...
     b8d:	68 84 4c 00 00       	push   $0x4c84
     b92:	6a 01                	push   $0x1
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ba9:	68 d0 4c 00 00       	push   $0x4cd0
     bae:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bfa:	6a 01                	push   $0x1
     bfc:	68 95 52 00 00       	push   $0x5295
     ...
     c14:	68 da 4c 00 00       	push   $0x4cda
     c19:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c46:	68 80 99 00 00       	push   $0x9980
    ...
    printf(1, "preempt read error");
     ...
     c5e:	68 ee 4c 00 00       	push   $0x4cee
     c63:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     c80:	58                   	pop    %eax
     c81:	5a                   	pop    %edx
     c82:	68 01 4d 00 00       	push   $0x4d01
     c87:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     ca6:	59                   	pop    %ecx
     ca7:	5b                   	pop    %ebx
     ca8:	68 0a 4d 00 00       	push   $0x4d0a
     cad:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     cc3:	5e                   	pop    %esi
     cc4:	5f                   	pop    %edi
     cc5:	68 13 4d 00 00       	push   $0x4d13
     cca:	6a 01                	push   $0x1
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d0e:	68 7d 58 00 00       	push   $0x587d
     d13:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     d2b:	68 1f 4d 00 00       	push   $0x4d1f
     d30:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d4b:	68 2f 4d 00 00       	push   $0x4d2f
     d50:	6a 01                	push   $0x1
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d79:	68 3c 4d 00 00       	push   $0x4d3c
     d7e:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     df1:	58                   	pop    %eax
     df2:	5a                   	pop    %edx
     df3:	68 60 4d 00 00       	push   $0x4d60
     df8:	6a 01                	push   $0x1
    ...
    if(m1 == 0){
     ...
     e1b:	68 46 4d 00 00       	push   $0x4d46
     e20:	6a 01                	push   $0x1
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ecc:	68 68 5a 00 00       	push   $0x5a68
     ed1:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     efa:	5a                   	pop    %edx
     efb:	6a 00                	push   $0x0
     efd:	68 77 4d 00 00       	push   $0x4d77
  ...
  unlink("sharedfd");
     f6a:	c7 04 24 77 4d 00 00 	movl   $0x4d77,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     f8f:	68 80 4d 00 00       	push   $0x4d80
     f94:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fa9:	68 3c 5a 00 00       	push   $0x5a3c
     fae:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fc3:	68 88 5a 00 00       	push   $0x5a88
     fc8:	6a 01                	push   $0x1
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     fdf:	53                   	push   %ebx
     fe0:	52                   	push   %edx
     fe1:	68 8d 4d 00 00       	push   $0x4d8d
     fe6:	6a 01                	push   $0x1
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    1006:	be a2 4d 00 00       	mov    $0x4da2,%esi
...
fourfiles(void)
{
  ...
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1010:	c7 45 d8 a2 4d 00 00 	movl   $0x4da2,-0x28(%ebp)
    1017:	c7 45 dc eb 4e 00 00 	movl   $0x4eeb,-0x24(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    101e:	68 a8 4d 00 00       	push   $0x4da8
    1023:	6a 01                	push   $0x1
// time, to test block allocation.
void
fourfiles(void)
{
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    1025:	c7 45 e0 ef 4e 00 00 	movl   $0x4eef,-0x20(%ebp)
    102c:	c7 45 e4 a5 4d 00 00 	movl   $0x4da5,-0x1c(%ebp)
  char *fname;
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1081:	c7 45 d4 a2 4d 00 00 	movl   $0x4da2,-0x2c(%ebp)
  }
  ...
  for(i = 0; i < 2; i++){
    ...
    10a8:	68 80 99 00 00       	push   $0x9980
    10ad:	56                   	push   %esi
    ...
    10bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(j = 0; j < n; j++){
        if(buf[j] != '0'+i){
    10c0:	0f be 8a 80 99 00 00 	movsbl 0x9980(%edx),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    1107:	68 e6 4d 00 00       	push   $0x4de6
    110c:	6a 01                	push   $0x1
    ...
    112c:	68 c9 4d 00 00       	push   $0x4dc9
    1131:	6a 01                	push   $0x1
    ...
    1165:	68 80 99 00 00       	push   $0x9980
    ...
    117a:	68 80 99 00 00       	push   $0x9980
    117f:	56                   	push   %esi
    ...
    119c:	50                   	push   %eax
    119d:	68 b8 4d 00 00       	push   $0x4db8
    11a2:	6a 01                	push   $0x1
    ...
    11b1:	68 43 50 00 00       	push   $0x5043
    11b6:	6a 01                	push   $0x1
    ...
    11c5:	53                   	push   %ebx
    11c6:	68 d5 4d 00 00       	push   $0x4dd5
    11cb:	6a 01                	push   $0x1
    ...
    11da:	68 7d 58 00 00       	push   $0x587d
    11df:	6a 01                	push   $0x1
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    11fb:	68 f4 4d 00 00       	push   $0x4df4
    1200:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    12fc:	68 07 4e 00 00       	push   $0x4e07
    1301:	6a 01                	push   $0x1
    ...
    1388:	68 f5 49 00 00       	push   $0x49f5
    138d:	6a 01                	push   $0x1
    ...
    13a8:	57                   	push   %edi
    13a9:	68 b4 5a 00 00       	push   $0x5ab4
    13ae:	6a 01                	push   $0x1
    ...
    13bd:	68 43 50 00 00       	push   $0x5043
    13c2:	6a 01                	push   $0x1
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    13d1:	68 7d 58 00 00       	push   $0x587d
    13d6:	6a 01                	push   $0x1
    ...
    13ed:	57                   	push   %edi
    13ee:	68 d8 5a 00 00       	push   $0x5ad8
    13f3:	6a 01                	push   $0x1
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1408:	68 18 4e 00 00       	push   $0x4e18
    140d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    141b:	68 29 4e 00 00       	push   $0x4e29
  ...
  write(fd, "hello", 5);
    ...
    1435:	6a 05                	push   $0x5
    1437:	68 4e 4e 00 00       	push   $0x4e4e
    143c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    144b:	5a                   	pop    %edx
    144c:	6a 02                	push   $0x2
    144e:	68 29 4e 00 00       	push   $0x4e29
  ...
  if(unlink("unlinkread") != 0){
    ...
    1468:	68 29 4e 00 00       	push   $0x4e29
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1485:	68 29 4e 00 00       	push   $0x4e29
  ...
  write(fd1, "yyy", 3);
    1494:	6a 03                	push   $0x3
    1496:	68 86 4e 00 00       	push   $0x4e86
    149b:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14b1:	68 80 99 00 00       	push   $0x9980
    14b6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14c8:	80 3d 80 99 00 00 68 	cmpb   $0x68,0x9980
  ...
  if(write(fd, buf, 10) != 10){
    ...
    14d4:	6a 0a                	push   $0xa
    14d6:	68 80 99 00 00       	push   $0x9980
    14db:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    14f2:	c7 04 24 29 4e 00 00 	movl   $0x4e29,(%esp)
    14f9:	e8 f4 23 00 00       	call   38f2 <unlink>
  printf(1, "unlinkread ok\n");
    14fe:	58                   	pop    %eax
    14ff:	5a                   	pop    %edx
    1500:	68 d1 4e 00 00       	push   $0x4ed1
    1505:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1516:	51                   	push   %ecx
    1517:	51                   	push   %ecx
    1518:	68 34 4e 00 00       	push   $0x4e34
    151d:	6a 01                	push   $0x1
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1529:	51                   	push   %ecx
    152a:	51                   	push   %ecx
    152b:	68 b8 4e 00 00       	push   $0x4eb8
    1530:	6a 01                	push   $0x1
  ...
  if(buf[0] != 'h'){
    ...
    153c:	53                   	push   %ebx
    153d:	53                   	push   %ebx
    153e:	68 a1 4e 00 00       	push   $0x4ea1
    1543:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    154f:	56                   	push   %esi
    1550:	56                   	push   %esi
    1551:	68 8a 4e 00 00       	push   $0x4e8a
    1556:	6a 01                	push   $0x1
  ...
  if(unlink("unlinkread") != 0){
    ...
    1562:	50                   	push   %eax
    1563:	50                   	push   %eax
    1564:	68 6c 4e 00 00       	push   $0x4e6c
    1569:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1575:	50                   	push   %eax
    1576:	50                   	push   %eax
    1577:	68 54 4e 00 00       	push   $0x4e54
    157c:	6a 01                	push   $0x1
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1597:	68 e0 4e 00 00       	push   $0x4ee0
    159c:	6a 01                	push   $0x1
    159e:	e8 6d 24 00 00       	call   3a10 <printf>

  unlink("lf1");
    15a3:	c7 04 24 ea 4e 00 00 	movl   $0x4eea,(%esp)
    15aa:	e8 43 23 00 00       	call   38f2 <unlink>
  unlink("lf2");
    15af:	c7 04 24 ee 4e 00 00 	movl   $0x4eee,(%esp)
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    15c2:	68 ea 4e 00 00       	push   $0x4eea
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    15dc:	6a 05                	push   $0x5
    15de:	68 4e 4e 00 00       	push   $0x4e4e
    15e3:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    15fe:	5b                   	pop    %ebx
    15ff:	58                   	pop    %eax
    1600:	68 ee 4e 00 00       	push   $0x4eee
    1605:	68 ea 4e 00 00       	push   $0x4eea
  ...
  unlink("lf1");
    ...
    161d:	68 ea 4e 00 00       	push   $0x4eea
  ...
  if(open("lf1", 0) >= 0){
    ...
    1628:	5a                   	pop    %edx
    1629:	6a 00                	push   $0x0
    162b:	68 ea 4e 00 00       	push   $0x4eea
  ...
  fd = open("lf2", 0);
    ...
    1643:	6a 00                	push   $0x0
    1645:	68 ee 4e 00 00       	push   $0x4eee
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1664:	68 80 99 00 00       	push   $0x9980
    1669:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    1684:	58                   	pop    %eax
    1685:	5a                   	pop    %edx
    1686:	68 ee 4e 00 00       	push   $0x4eee
    168b:	68 ee 4e 00 00       	push   $0x4eee
  ...
  unlink("lf2");
    ...
    16a3:	68 ee 4e 00 00       	push   $0x4eee
    16a8:	e8 45 22 00 00       	call   38f2 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ad:	59                   	pop    %ecx
    16ae:	5b                   	pop    %ebx
    16af:	68 ea 4e 00 00       	push   $0x4eea
    16b4:	68 ee 4e 00 00       	push   $0x4eee
  ...
  if(link(".", "lf1") >= 0){
    ...
    16c8:	68 ea 4e 00 00       	push   $0x4eea
    16cd:	68 b2 51 00 00       	push   $0x51b2
  ...
  printf(1, "linktest ok\n");
    ...
    16e1:	68 88 4f 00 00       	push   $0x4f88
    16e6:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    16f5:	50                   	push   %eax
    16f6:	50                   	push   %eax
    16f7:	68 f2 4e 00 00       	push   $0x4ef2
    16fc:	6a 01                	push   $0x1
  ...
  if(link(".", "lf1") >= 0){
    ...
    1708:	50                   	push   %eax
    1709:	50                   	push   %eax
    170a:	68 6c 4f 00 00       	push   $0x4f6c
    170f:	6a 01                	push   $0x1
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    171b:	52                   	push   %edx
    171c:	52                   	push   %edx
    171d:	68 20 5b 00 00       	push   $0x5b20
    1722:	6a 01                	push   $0x1
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    172e:	50                   	push   %eax
    172f:	50                   	push   %eax
    1730:	68 4e 4f 00 00       	push   $0x4f4e
    1735:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1741:	51                   	push   %ecx
    1742:	51                   	push   %ecx
    1743:	68 3d 4f 00 00       	push   $0x4f3d
    1748:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1754:	53                   	push   %ebx
    1755:	53                   	push   %ebx
    1756:	68 2c 4f 00 00       	push   $0x4f2c
    175b:	6a 01                	push   $0x1
  ...
  if(open("lf1", 0) >= 0){
    ...
    1767:	50                   	push   %eax
    1768:	50                   	push   %eax
    1769:	68 f8 5a 00 00       	push   $0x5af8
    176e:	6a 01                	push   $0x1
  ...
  if(link("lf1", "lf2") < 0){
    ...
    177a:	51                   	push   %ecx
    177b:	51                   	push   %ecx
    177c:	68 17 4f 00 00       	push   $0x4f17
    1781:	6a 01                	push   $0x1
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    178d:	50                   	push   %eax
    178e:	50                   	push   %eax
    178f:	68 05 4f 00 00       	push   $0x4f05
    1794:	6a 01                	push   $0x1
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    17b3:	68 95 4f 00 00       	push   $0x4f95
    17b8:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1870:	53                   	push   %ebx
    1871:	68 a8 4f 00 00       	push   $0x4fa8
    1876:	6a 01                	push   $0x1
    ...
    188b:	53                   	push   %ebx
    188c:	68 a5 4f 00 00       	push   $0x4fa5
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid && (i % 3) == 1){
      link("C0", file);
    18a6:	53                   	push   %ebx
    18a7:	68 a5 4f 00 00       	push   $0x4fa5
  ...
  fd = open(".", 0);
    ...
    18dc:	5e                   	pop    %esi
    18dd:	6a 00                	push   $0x0
    18df:	68 b2 51 00 00       	push   $0x51b2
  ...
  printf(1, "concreate ok\n");
    ...
    1a33:	68 fa 4f 00 00       	push   $0x4ffa
    1a38:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1a4a:	68 7d 58 00 00       	push   $0x587d
    1a4f:	6a 01                	push   $0x1
  ...
  if(n != 40){
    ...
    1a5e:	68 44 5b 00 00       	push   $0x5b44
    1a63:	6a 01                	push   $0x1
    ...
    1a75:	50                   	push   %eax
    1a76:	68 dd 4f 00 00       	push   $0x4fdd
    1a7b:	6a 01                	push   $0x1
    ...
    1a8d:	50                   	push   %eax
    1a8e:	68 c4 4f 00 00       	push   $0x4fc4
    1a93:	6a 01                	push   $0x1
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1ab9:	68 08 50 00 00       	push   $0x5008
    1abe:	6a 01                	push   $0x1
    1ac0:	e8 4b 1f 00 00       	call   3a10 <printf>

  unlink("x");
    1ac5:	c7 04 24 95 52 00 00 	movl   $0x5295,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    1b08:	68 95 52 00 00       	push   $0x5295
  ...
  for(i = 0; i < 100; i++){
    ...
    1b3d:	68 95 52 00 00       	push   $0x5295
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b66:	68 1d 50 00 00       	push   $0x501d
    1b6b:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 100; i++){
    ...
    1b83:	68 95 52 00 00       	push   $0x5295
    1b88:	68 19 50 00 00       	push   $0x5019
  ...
  if(pid < 0){
    ...
    1b9d:	68 7d 58 00 00       	push   $0x587d
    1ba2:	6a 01                	push   $0x1
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1bc8:	68 2c 50 00 00       	push   $0x502c
    1bcd:	6a 01                	push   $0x1
    1bcf:	e8 3c 1e 00 00       	call   3a10 <printf>
  unlink("bd");
    1bd4:	c7 04 24 39 50 00 00 	movl   $0x5039,(%esp)
  ...
  fd = open("bd", O_CREATE);
    ...
    1be7:	68 39 50 00 00       	push   $0x5039
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
    1c1c:	56                   	push   %esi
    1c1d:	68 39 50 00 00       	push   $0x5039
  }
  close(fd);
  ...
  unlink("bd");
    1c53:	68 39 50 00 00       	push   $0x5039
  ...
  printf(1, "bigdir ok\n");
    ...
    1c9c:	68 7b 50 00 00       	push   $0x507b
    1ca1:	6a 01                	push   $0x1
    ...
    1cb5:	68 52 50 00 00       	push   $0x5052
    1cba:	6a 01                	push   $0x1
    ...
    1cc9:	68 66 50 00 00       	push   $0x5066
    1cce:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    1cdd:	68 3c 50 00 00       	push   $0x503c
    1ce2:	6a 01                	push   $0x1
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cf7:	68 86 50 00 00       	push   $0x5086
    1cfc:	6a 01                	push   $0x1
    1cfe:	e8 0d 1d 00 00       	call   3a10 <printf>

  unlink("ff");
    1d03:	c7 04 24 0f 51 00 00 	movl   $0x510f,(%esp)
    1d0a:	e8 e3 1b 00 00       	call   38f2 <unlink>
  if(mkdir("dd") != 0){
    1d0f:	c7 04 24 ac 51 00 00 	movl   $0x51ac,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	68 e5 50 00 00       	push   $0x50e5
  ...
  write(fd, "ff", 2);
    ...
    1d48:	6a 02                	push   $0x2
    1d4a:	68 0f 51 00 00       	push   $0x510f
    1d4f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d5d:	c7 04 24 ac 51 00 00 	movl   $0x51ac,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d77:	68 c0 50 00 00       	push   $0x50c0
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1d94:	68 e2 50 00 00       	push   $0x50e2
  ...
  write(fd, "FF", 2);
    ...
    1dae:	6a 02                	push   $0x2
    1db0:	68 03 51 00 00       	push   $0x5103
    1db5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1dc4:	5a                   	pop    %edx
    1dc5:	6a 00                	push   $0x0
    1dc7:	68 06 51 00 00       	push   $0x5106
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1de6:	68 80 99 00 00       	push   $0x9980
    1deb:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1dfd:	80 3d 80 99 00 00 66 	cmpb   $0x66,0x9980
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e13:	5b                   	pop    %ebx
    1e14:	58                   	pop    %eax
    1e15:	68 46 51 00 00       	push   $0x5146
    1e1a:	68 e2 50 00 00       	push   $0x50e2
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e32:	68 e2 50 00 00       	push   $0x50e2
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e4a:	6a 00                	push   $0x0
    1e4c:	68 e2 50 00 00       	push   $0x50e2
  ...
  if(chdir("dd") != 0){
    ...
    1e64:	68 ac 51 00 00       	push   $0x51ac
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e7c:	68 7a 51 00 00       	push   $0x517a
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1e94:	68 a0 51 00 00       	push   $0x51a0
  ...
  if(chdir("./..") != 0){
    ...
    1eac:	68 af 51 00 00       	push   $0x51af
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ec4:	6a 00                	push   $0x0
    1ec6:	68 46 51 00 00       	push   $0x5146
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1ee5:	68 80 99 00 00       	push   $0x9980
    1eea:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f06:	5b                   	pop    %ebx
    1f07:	6a 00                	push   $0x0
    1f09:	68 e2 50 00 00       	push   $0x50e2
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f26:	68 fa 51 00 00       	push   $0x51fa
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f43:	68 1f 52 00 00       	push   $0x521f
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f60:	68 ac 51 00 00       	push   $0x51ac
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f78:	6a 02                	push   $0x2
    1f7a:	68 ac 51 00 00       	push   $0x51ac
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1f92:	6a 01                	push   $0x1
    1f94:	68 ac 51 00 00       	push   $0x51ac
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fac:	68 8e 52 00 00       	push   $0x528e
    1fb1:	68 fa 51 00 00       	push   $0x51fa
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fc9:	68 8e 52 00 00       	push   $0x528e
    1fce:	68 1f 52 00 00       	push   $0x521f
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1fe6:	68 46 51 00 00       	push   $0x5146
    1feb:	68 e5 50 00 00       	push   $0x50e5
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2003:	68 fa 51 00 00       	push   $0x51fa
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    201b:	68 1f 52 00 00       	push   $0x521f
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2033:	68 46 51 00 00       	push   $0x5146
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    204b:	68 1f 52 00 00       	push   $0x521f
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2063:	68 fa 51 00 00       	push   $0x51fa
  ...
  if(chdir("dd/ff") == 0){
    ...
    207b:	68 e5 50 00 00       	push   $0x50e5
  ...
  if(chdir("dd/xx") == 0){
    ...
    2093:	68 91 52 00 00       	push   $0x5291
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20ab:	68 46 51 00 00       	push   $0x5146
  ...
  if(unlink("dd/ff") != 0){
    ...
    20c3:	68 e5 50 00 00       	push   $0x50e5
  ...
  if(unlink("dd") == 0){
    ...
    20db:	68 ac 51 00 00       	push   $0x51ac
  ...
  if(unlink("dd/dd") < 0){
    ...
    20f3:	68 c1 50 00 00       	push   $0x50c1
  ...
  if(unlink("dd") < 0){
    ...
    210b:	68 ac 51 00 00       	push   $0x51ac
  ...
  printf(1, "subdir ok\n");
    ...
    2123:	68 8e 53 00 00       	push   $0x538e
    2128:	6a 01                	push   $0x1
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2137:	50                   	push   %eax
    2138:	50                   	push   %eax
    2139:	68 2b 51 00 00       	push   $0x512b
    213e:	6a 01                	push   $0x1
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    214a:	50                   	push   %eax
    214b:	50                   	push   %eax
    214c:	68 86 51 00 00       	push   $0x5186
    2151:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    215d:	52                   	push   %edx
    215e:	52                   	push   %edx
    215f:	68 51 51 00 00       	push   $0x5151
    2164:	6a 01                	push   $0x1
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2170:	50                   	push   %eax
    2171:	50                   	push   %eax
    2172:	68 03 52 00 00       	push   $0x5203
    2177:	6a 01                	push   $0x1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2183:	52                   	push   %edx
    2184:	52                   	push   %edx
    2185:	68 e8 5b 00 00       	push   $0x5be8
    218a:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2196:	52                   	push   %edx
    2197:	52                   	push   %edx
    2198:	68 97 52 00 00       	push   $0x5297
    219d:	6a 01                	push   $0x1
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    21a9:	51                   	push   %ecx
    21aa:	51                   	push   %ecx
    21ab:	68 58 5c 00 00       	push   $0x5c58
    21b0:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    21bc:	50                   	push   %eax
    21bd:	50                   	push   %eax
    21be:	68 12 51 00 00       	push   $0x5112
    21c3:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    21cf:	51                   	push   %ecx
    21d0:	51                   	push   %ecx
    21d1:	68 eb 50 00 00       	push   $0x50eb
    21d6:	6a 01                	push   $0x1
  ...
  if(chdir("./..") != 0){
    ...
    21e2:	50                   	push   %eax
    21e3:	50                   	push   %eax
    21e4:	68 b4 51 00 00       	push   $0x51b4
    21e9:	6a 01                	push   $0x1
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    21f5:	51                   	push   %ecx
    21f6:	51                   	push   %ecx
    21f7:	68 a0 5b 00 00       	push   $0x5ba0
    21fc:	6a 01                	push   $0x1
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2208:	53                   	push   %ebx
    2209:	53                   	push   %ebx
    220a:	68 34 5c 00 00       	push   $0x5c34
    220f:	6a 01                	push   $0x1
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    221b:	50                   	push   %eax
    221c:	50                   	push   %eax
    221d:	68 10 5c 00 00       	push   $0x5c10
    2222:	6a 01                	push   $0x1
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    222e:	50                   	push   %eax
    222f:	50                   	push   %eax
    2230:	68 73 52 00 00       	push   $0x5273
    2235:	6a 01                	push   $0x1
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2241:	50                   	push   %eax
    2242:	50                   	push   %eax
    2243:	68 5a 52 00 00       	push   $0x525a
    2248:	6a 01                	push   $0x1
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2254:	50                   	push   %eax
    2255:	50                   	push   %eax
    2256:	68 44 52 00 00       	push   $0x5244
    225b:	6a 01                	push   $0x1
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2267:	50                   	push   %eax
    2268:	50                   	push   %eax
    2269:	68 28 52 00 00       	push   $0x5228
    226e:	6a 01                	push   $0x1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    228d:	50                   	push   %eax
    228e:	50                   	push   %eax
    228f:	68 c4 5b 00 00       	push   $0x5bc4
    2294:	6a 01                	push   $0x1
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    22a0:	53                   	push   %ebx
    22a1:	53                   	push   %ebx
    22a2:	68 c7 50 00 00       	push   $0x50c7
    22a7:	6a 01                	push   $0x1
  ...
  if(unlink("dd") >= 0){
    ...
    22b3:	50                   	push   %eax
    22b4:	50                   	push   %eax
    22b5:	68 78 5b 00 00       	push   $0x5b78
    22ba:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    22c6:	50                   	push   %eax
    22c7:	50                   	push   %eax
    22c8:	68 ab 50 00 00       	push   $0x50ab
    22cd:	6a 01                	push   $0x1
  ...
  if(mkdir("dd") != 0){
    ...
    22d9:	50                   	push   %eax
    22da:	50                   	push   %eax
    22db:	68 93 50 00 00       	push   $0x5093
    22e0:	6a 01                	push   $0x1
  ...
  if(unlink("dd") < 0){
    ...
    22ec:	50                   	push   %eax
    22ed:	50                   	push   %eax
    22ee:	68 7c 53 00 00       	push   $0x537c
    22f3:	6a 01                	push   $0x1
  ...
  if(unlink("dd/dd") < 0){
    ...
    22ff:	52                   	push   %edx
    2300:	52                   	push   %edx
    2301:	68 67 53 00 00       	push   $0x5367
    2306:	6a 01                	push   $0x1
  ...
  if(unlink("dd") == 0){
    ...
    2312:	51                   	push   %ecx
    2313:	51                   	push   %ecx
    2314:	68 7c 5c 00 00       	push   $0x5c7c
    2319:	6a 01                	push   $0x1
  ...
  if(unlink("dd/ff") != 0){
    ...
    2325:	53                   	push   %ebx
    2326:	53                   	push   %ebx
    2327:	68 52 53 00 00       	push   $0x5352
    232c:	6a 01                	push   $0x1
  ...
  if(chdir("dd/xx") == 0){
    ...
    2338:	50                   	push   %eax
    2339:	50                   	push   %eax
    233a:	68 3a 53 00 00       	push   $0x533a
    233f:	6a 01                	push   $0x1
  ...
  if(chdir("dd/ff") == 0){
    ...
    234b:	50                   	push   %eax
    234c:	50                   	push   %eax
    234d:	68 22 53 00 00       	push   $0x5322
    2352:	6a 01                	push   $0x1
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    235e:	50                   	push   %eax
    235f:	50                   	push   %eax
    2360:	68 06 53 00 00       	push   $0x5306
    2365:	6a 01                	push   $0x1
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2371:	50                   	push   %eax
    2372:	50                   	push   %eax
    2373:	68 ea 52 00 00       	push   $0x52ea
    2378:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2384:	50                   	push   %eax
    2385:	50                   	push   %eax
    2386:	68 cd 52 00 00       	push   $0x52cd
    238b:	6a 01                	push   $0x1
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2397:	50                   	push   %eax
    2398:	50                   	push   %eax
    2399:	68 b2 52 00 00       	push   $0x52b2
    239e:	6a 01                	push   $0x1
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    23aa:	50                   	push   %eax
    23ab:	50                   	push   %eax
    23ac:	68 df 51 00 00       	push   $0x51df
    23b1:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    23bd:	50                   	push   %eax
    23be:	50                   	push   %eax
    23bf:	68 c7 51 00 00       	push   $0x51c7
    23c4:	6a 01                	push   $0x1
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23dd:	68 99 53 00 00       	push   $0x5399
    23e2:	6a 01                	push   $0x1
    23e4:	e8 27 16 00 00       	call   3a10 <printf>

  unlink("bigwrite");
    23e9:	c7 04 24 a8 53 00 00 	movl   $0x53a8,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2408:	68 a8 53 00 00       	push   $0x53a8
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    241e:	53                   	push   %ebx
    241f:	68 80 99 00 00       	push   $0x9980
    2424:	50                   	push   %eax
    ...
    2434:	53                   	push   %ebx
    2435:	68 80 99 00 00       	push   $0x9980
    243a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2456:	c7 04 24 a8 53 00 00 	movl   $0x53a8,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2470:	68 db 53 00 00       	push   $0x53db
    2475:	6a 01                	push   $0x1
    ...
    2486:	50                   	push   %eax
    2487:	53                   	push   %ebx
    2488:	68 c9 53 00 00       	push   $0x53c9
    248d:	6a 01                	push   $0x1
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    249c:	68 b1 53 00 00       	push   $0x53b1
    24a1:	6a 01                	push   $0x1
...
bigfile(void)
{
  ...
  fd = open("bigfile", 0);
    ...
    253e:	5b                   	pop    %ebx
    253f:	6a 00                	push   $0x0
    2541:	68 04 54 00 00       	push   $0x5404
  ...
  if(fd < 0){
    ...
    256b:	0f be 05 80 99 00 00 	movsbl 0x9980,%eax
    2572:	89 fa                	mov    %edi,%edx
    2574:	d1 fa                	sar    %edx
    2576:	39 d0                	cmp    %edx,%eax
    2578:	75 6e                	jne    25e8 <bigfile+0x138>
    257a:	0f be 15 ab 9a 00 00 	movsbl 0x9aab,%edx
  ...
  for(i = 0; ; i++){
    ...
    2596:	68 80 99 00 00       	push   $0x9980
    259b:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25c5:	68 04 54 00 00       	push   $0x5404
    25ca:	e8 23 13 00 00       	call   38f2 <unlink>

  printf(1, "bigfile test ok\n");
    25cf:	58                   	pop    %eax
    25d0:	5a                   	pop    %edx
    25d1:	68 93 54 00 00       	push   $0x5493
    25d6:	6a 01                	push   $0x1
    ...
    25eb:	68 60 54 00 00       	push   $0x5460
    25f0:	6a 01                	push   $0x1
    ...
    25ff:	68 4c 54 00 00       	push   $0x544c
    2604:	6a 01                	push   $0x1
  ...
  for(i = 0; ; i++){
    ...
    2613:	68 37 54 00 00       	push   $0x5437
    2618:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 20; i++){
    ...
    2627:	68 0c 54 00 00       	push   $0x540c
    262c:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    263b:	68 22 54 00 00       	push   $0x5422
    2640:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    264f:	68 f6 53 00 00       	push   $0x53f6
    2654:	6a 01                	push   $0x1
  ...
  if(total != 20*600){
    ...
    2663:	68 79 54 00 00       	push   $0x5479
    2668:	6a 01                	push   $0x1
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    2686:	68 a4 54 00 00       	push   $0x54a4
    268b:	6a 01                	push   $0x1
    268d:	e8 7e 13 00 00       	call   3a10 <printf>

  if(mkdir("12345678901234") != 0){
    2692:	c7 04 24 df 54 00 00 	movl   $0x54df,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26ac:	68 9c 5c 00 00       	push   $0x5c9c
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c9:	68 ec 5c 00 00       	push   $0x5cec
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26e8:	5a                   	pop    %edx
    26e9:	6a 00                	push   $0x0
    26eb:	68 5c 5d 00 00       	push   $0x5d5c
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2705:	c7 04 24 d0 54 00 00 	movl   $0x54d0,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    271b:	68 f8 5d 00 00       	push   $0x5df8
  ...
  printf(1, "fourteen ok\n");
    ...
    272f:	68 ee 54 00 00       	push   $0x54ee
    2734:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2740:	50                   	push   %eax
    2741:	50                   	push   %eax
    2742:	68 b3 54 00 00       	push   $0x54b3
    2747:	6a 01                	push   $0x1
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2753:	50                   	push   %eax
    2754:	50                   	push   %eax
    2755:	68 18 5e 00 00       	push   $0x5e18
    275a:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2766:	52                   	push   %edx
    2767:	52                   	push   %edx
    2768:	68 c8 5d 00 00       	push   $0x5dc8
    276d:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    2779:	51                   	push   %ecx
    277a:	51                   	push   %ecx
    277b:	68 8c 5d 00 00       	push   $0x5d8c
    2780:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    278c:	51                   	push   %ecx
    278d:	51                   	push   %ecx
    278e:	68 1c 5d 00 00       	push   $0x5d1c
    2793:	6a 01                	push   $0x1
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    279f:	50                   	push   %eax
    27a0:	50                   	push   %eax
    27a1:	68 bc 5c 00 00       	push   $0x5cbc
    27a6:	6a 01                	push   $0x1
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    27c6:	68 fb 54 00 00       	push   $0x54fb
    27cb:	6a 01                	push   $0x1
    27cd:	e8 3e 12 00 00       	call   3a10 <printf>
  if(mkdir("dots") != 0){
    27d2:	c7 04 24 07 55 00 00 	movl   $0x5507,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    27ec:	68 07 55 00 00       	push   $0x5507
  ...
  if(unlink(".") == 0){
    ...
    2804:	68 b2 51 00 00       	push   $0x51b2
  ...
  if(unlink("..") == 0){
    ...
    281c:	68 b1 51 00 00       	push   $0x51b1
  ...
  if(chdir("/") != 0){
    ...
    2834:	68 85 49 00 00       	push   $0x4985
  ...
  if(unlink("dots/.") == 0){
    ...
    284c:	68 4f 55 00 00       	push   $0x554f
  ...
  if(unlink("dots/..") == 0){
    ...
    2860:	68 6d 55 00 00       	push   $0x556d
  ...
  if(unlink("dots") != 0){
    ...
    2874:	68 07 55 00 00       	push   $0x5507
  ...
  printf(1, "rmdot ok\n");
    ...
    2888:	68 a2 55 00 00       	push   $0x55a2
    288d:	6a 01                	push   $0x1
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    2899:	50                   	push   %eax
    289a:	50                   	push   %eax
    289b:	68 0c 55 00 00       	push   $0x550c
    28a0:	6a 01                	push   $0x1
  ...
  if(unlink("dots") != 0){
    ...
    28ac:	50                   	push   %eax
    28ad:	50                   	push   %eax
    28ae:	68 8d 55 00 00       	push   $0x558d
    28b3:	6a 01                	push   $0x1
  ...
  if(unlink("dots/..") == 0){
    ...
    28bf:	52                   	push   %edx
    28c0:	52                   	push   %edx
    28c1:	68 75 55 00 00       	push   $0x5575
    28c6:	6a 01                	push   $0x1
  ...
  if(unlink("dots/.") == 0){
    ...
    28d2:	51                   	push   %ecx
    28d3:	51                   	push   %ecx
    28d4:	68 56 55 00 00       	push   $0x5556
    28d9:	6a 01                	push   $0x1
  ...
  if(chdir("/") != 0){
    ...
    28e5:	50                   	push   %eax
    28e6:	50                   	push   %eax
    28e7:	68 87 49 00 00       	push   $0x4987
    28ec:	6a 01                	push   $0x1
  ...
  if(unlink("..") == 0){
    ...
    28f8:	50                   	push   %eax
    28f9:	50                   	push   %eax
    28fa:	68 40 55 00 00       	push   $0x5540
    28ff:	6a 01                	push   $0x1
  ...
  if(unlink(".") == 0){
    ...
    290b:	50                   	push   %eax
    290c:	50                   	push   %eax
    290d:	68 32 55 00 00       	push   $0x5532
    2912:	6a 01                	push   $0x1
  ...
  if(chdir("dots") != 0){
    ...
    291e:	50                   	push   %eax
    291f:	50                   	push   %eax
    2920:	68 1f 55 00 00       	push   $0x551f
    2925:	6a 01                	push   $0x1
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2947:	68 ac 55 00 00       	push   $0x55ac
    294c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    295a:	68 b9 55 00 00       	push   $0x55b9
  ...
  if(chdir("dirfile") == 0){
    2978:	c7 04 24 b9 55 00 00 	movl   $0x55b9,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2992:	6a 00                	push   $0x0
    2994:	68 f2 55 00 00       	push   $0x55f2
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29b1:	68 f2 55 00 00       	push   $0x55f2
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29c9:	68 f2 55 00 00       	push   $0x55f2
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    29e1:	68 f2 55 00 00       	push   $0x55f2
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    29f9:	68 f2 55 00 00       	push   $0x55f2
    29fe:	68 56 56 00 00       	push   $0x5656
  ...
  if(unlink("dirfile") != 0){
    ...
    2a16:	68 b9 55 00 00       	push   $0x55b9
  ...
  fd = open(".", O_RDWR);
    ...
    2a2e:	6a 02                	push   $0x2
    2a30:	68 b2 51 00 00       	push   $0x51b2
  ...
  fd = open(".", 0);
    ...
    2a48:	6a 00                	push   $0x0
    2a4a:	68 b2 51 00 00       	push   $0x51b2
  ...
  if(write(fd, "x", 1) > 0){
    2a59:	6a 01                	push   $0x1
    2a5b:	68 95 52 00 00       	push   $0x5295
    2a60:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a76:	58                   	pop    %eax
    2a77:	5a                   	pop    %edx
    2a78:	68 89 56 00 00       	push   $0x5689
    2a7d:	6a 01                	push   $0x1
  ...
  if(fd >= 0){
    ...
    2a8c:	50                   	push   %eax
    2a8d:	50                   	push   %eax
    2a8e:	68 fd 55 00 00       	push   $0x55fd
    2a93:	6a 01                	push   $0x1
  ...
  if(chdir("dirfile") == 0){
    ...
    2a9f:	50                   	push   %eax
    2aa0:	50                   	push   %eax
    2aa1:	68 d8 55 00 00       	push   $0x55d8
    2aa6:	6a 01                	push   $0x1
  ...
  if(fd < 0){
    ...
    2ab2:	52                   	push   %edx
    2ab3:	52                   	push   %edx
    2ab4:	68 c1 55 00 00       	push   $0x55c1
    2ab9:	6a 01                	push   $0x1
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ac5:	51                   	push   %ecx
    2ac6:	51                   	push   %ecx
    2ac7:	68 75 56 00 00       	push   $0x5675
    2acc:	6a 01                	push   $0x1
  ...
  if(fd >= 0){
    ...
    2ad8:	53                   	push   %ebx
    2ad9:	53                   	push   %ebx
    2ada:	68 6c 5e 00 00       	push   $0x5e6c
    2adf:	6a 01                	push   $0x1
  ...
  if(unlink("dirfile") != 0){
    ...
    2aeb:	50                   	push   %eax
    2aec:	50                   	push   %eax
    2aed:	68 5d 56 00 00       	push   $0x565d
    2af2:	6a 01                	push   $0x1
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2afe:	50                   	push   %eax
    2aff:	50                   	push   %eax
    2b00:	68 4c 5e 00 00       	push   $0x5e4c
    2b05:	6a 01                	push   $0x1
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2b11:	50                   	push   %eax
    2b12:	50                   	push   %eax
    2b13:	68 38 56 00 00       	push   $0x5638
    2b18:	6a 01                	push   $0x1
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2b24:	50                   	push   %eax
    2b25:	50                   	push   %eax
    2b26:	68 1b 56 00 00       	push   $0x561b
    2b2b:	6a 01                	push   $0x1
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2b4c:	68 99 56 00 00       	push   $0x5699
    2b51:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2b63:	68 aa 56 00 00       	push   $0x56aa
    ...
    2b7b:	68 aa 56 00 00       	push   $0x56aa
    ...
    2b93:	68 90 65 00 00       	push   $0x6590
    2b98:	e8 6d 0d 00 00       	call   390a <mkdir>
    link("README", "");
    2b9d:	59                   	pop    %ecx
    2b9e:	58                   	pop    %eax
    2b9f:	68 90 65 00 00       	push   $0x6590
    2ba4:	68 56 56 00 00       	push   $0x5656
    2ba9:	e8 54 0d 00 00       	call   3902 <link>
    fd = open("", O_CREATE);
    2bae:	58                   	pop    %eax
    2baf:	5a                   	pop    %edx
    2bb0:	68 00 02 00 00       	push   $0x200
    2bb5:	68 90 65 00 00       	push   $0x6590
    ...
    2bda:	68 94 52 00 00       	push   $0x5294
    ...
    2bfa:	68 94 52 00 00       	push   $0x5294
  ...
  chdir("/");
    ...
    2c13:	68 85 49 00 00       	push   $0x4985
    2c18:	e8 f5 0c 00 00       	call   3912 <chdir>
  printf(1, "empty file name OK\n");
    2c1d:	58                   	pop    %eax
    2c1e:	5a                   	pop    %edx
    2c1f:	68 d8 56 00 00       	push   $0x56d8
    2c24:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c36:	68 b0 56 00 00       	push   $0x56b0
    2c3b:	6a 01                	push   $0x1
    ...
    2c4a:	68 c4 56 00 00       	push   $0x56c4
    2c4f:	6a 01                	push   $0x1
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2c69:	68 ec 56 00 00       	push   $0x56ec
    2c6e:	6a 01                	push   $0x1
    ...
    2c80:	74 62                	je     2ce4 <forktest+0x84>
{
  ...
  printf(1, "fork test OK\n");
    ...
    2cbb:	68 1e 57 00 00       	push   $0x571e
    2cc0:	6a 01                	push   $0x1
  ...
  if(n == 1000){
    ...
    2cd3:	68 8c 5e 00 00       	push   $0x5e8c
    2cd8:	6a 01                	push   $0x1
  ...
  for(; n > 0; n--){
    ...
    2cec:	68 f7 56 00 00       	push   $0x56f7
    2cf1:	6a 01                	push   $0x1
  ...
  if(wait() != -1){
    ...
    2d00:	68 0b 57 00 00       	push   $0x570b
    2d05:	6a 01                	push   $0x1
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2d2b:	68 2c 57 00 00       	push   $0x572c
    2d30:	ff 35 a0 71 00 00    	pushl  0x71a0
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f9c:	68 d4 57 00 00       	push   $0x57d4
    2fa1:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2fd0:	6a 01                	push   $0x1
    2fd2:	68 95 52 00 00       	push   $0x5295
  ...
  for(i = 0; i < 5000; i++){
    ...
    2ffe:	53                   	push   %ebx
    2fff:	57                   	push   %edi
    3000:	68 37 57 00 00       	push   $0x5737
    3005:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(c == (char*)0xffffffff){
    ...
    301b:	68 b9 57 00 00       	push   $0x57b9
    3020:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(pipe(fds) != 0){
    ...
    3033:	68 75 4c 00 00       	push   $0x4c75
    3038:	6a 01                	push   $0x1
    ...
    3047:	50                   	push   %eax
    3048:	53                   	push   %ebx
    3049:	68 a0 57 00 00       	push   $0x57a0
    304e:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3069:	68 7d 58 00 00       	push   $0x587d
    306e:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(c != a){
    ...
    307e:	50                   	push   %eax
    307f:	53                   	push   %ebx
    3080:	68 80 5f 00 00       	push   $0x5f80
    3085:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(*lastaddr == 99){
    ...
    3098:	68 50 5f 00 00       	push   $0x5f50
    309d:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    30ad:	57                   	push   %edi
    30ae:	53                   	push   %ebx
    30af:	68 28 5f 00 00       	push   $0x5f28
    30b4:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(c != a - 4096){
    ...
    30c4:	50                   	push   %eax
    30c5:	53                   	push   %ebx
    30c6:	68 f0 5e 00 00       	push   $0x5ef0
    30cb:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(c == (char*)0xffffffff){
    ...
    30de:	68 85 57 00 00       	push   $0x5785
    30e3:	ff 35 a0 71 00 00    	pushl  0x71a0
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    30f6:	68 b0 5e 00 00       	push   $0x5eb0
    30fb:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(c != a + 1){
    ...
    3113:	68 69 57 00 00       	push   $0x5769
    3118:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  if(pid < 0){
    ...
    312b:	68 52 57 00 00       	push   $0x5752
    3130:	ff 35 a0 71 00 00    	pushl  0x71a0
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    315a:	68 e2 57 00 00       	push   $0x57e2
    315f:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 f1 57 00 00       	push   $0x57f1
  ...
  printf(stdout, "validate ok\n");
    ...
    31c4:	68 15 58 00 00       	push   $0x5815
    31c9:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    31e6:	68 fc 57 00 00       	push   $0x57fc
    31eb:	ff 35 a0 71 00 00    	pushl  0x71a0
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3206:	68 22 58 00 00       	push   $0x5822
    320b:	ff 35 a0 71 00 00    	pushl  0x71a0
    3211:	e8 fa 07 00 00       	call   3a10 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d 60 72 00 00 00 	cmpb   $0x0,0x7260
    3220:	75 35                	jne    3257 <bsstest+0x57>
    3222:	b8 61 72 00 00       	mov    $0x7261,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
  for(i = 0; i < sizeof(uninit); i++){
    3238:	3d 70 99 00 00       	cmp    $0x9970,%eax
  ...
  printf(stdout, "bss test ok\n");
    ...
    3242:	68 3d 58 00 00       	push   $0x583d
    3247:	ff 35 a0 71 00 00    	pushl  0x71a0
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    325a:	68 2c 58 00 00       	push   $0x582c
    325f:	ff 35 a0 71 00 00    	pushl  0x71a0
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    3276:	68 4a 58 00 00       	push   $0x584a
  ...
  fd = open("bigarg-ok", 0);
    ...
    329a:	6a 00                	push   $0x0
    329c:	68 4a 58 00 00       	push   $0x584a
  ...
  unlink("bigarg-ok");
    32ba:	c7 04 24 4a 58 00 00 	movl   $0x584a,(%esp)
    32c1:	e8 2c 06 00 00       	call   38f2 <unlink>
}
    32c6:	83 c4 10             	add    $0x10,%esp
    32c9:	c9                   	leave  
    32ca:	c3                   	ret    
    32cb:	b8 c0 71 00 00       	mov    $0x71c0,%eax
  pid = fork();
  if(pid == 0){
    ...
    32d0:	c7 00 a4 5f 00 00    	movl   $0x5fa4,(%eax)
  ...
  if(pid == 0){
    ...
    int i;
    for(i = 0; i < MAXARG-1; i++)
    32d9:	3d 3c 72 00 00       	cmp    $0x723c,%eax
    ...
    32e0:	51                   	push   %ecx
    32e1:	51                   	push   %ecx
    32e2:	68 54 58 00 00       	push   $0x5854
    32e7:	ff 35 a0 71 00 00    	pushl  0x71a0
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    for(i = 0; i < MAXARG-1; i++)
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    32ed:	c7 05 3c 72 00 00 00 	movl   $0x0,0x723c
    32f4:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    32fc:	58                   	pop    %eax
    32fd:	5a                   	pop    %edx
    32fe:	68 c0 71 00 00       	push   $0x71c0
    3303:	68 21 4a 00 00       	push   $0x4a21
    3308:	e8 cd 05 00 00       	call   38da <exec>
    printf(stdout, "bigarg test ok\n");
    330d:	59                   	pop    %ecx
    330e:	58                   	pop    %eax
    330f:	68 61 58 00 00       	push   $0x5861
    3314:	ff 35 a0 71 00 00    	pushl  0x71a0
    331a:	e8 f1 06 00 00       	call   3a10 <printf>
    fd = open("bigarg-ok", O_CREATE);
    331f:	58                   	pop    %eax
    3320:	5a                   	pop    %edx
    3321:	68 00 02 00 00       	push   $0x200
    3326:	68 4a 58 00 00       	push   $0x584a
  ...
  if(fd < 0){
    ...
    333d:	50                   	push   %eax
    333e:	50                   	push   %eax
    333f:	68 8a 58 00 00       	push   $0x588a
    3344:	ff 35 a0 71 00 00    	pushl  0x71a0
    ...
    3354:	52                   	push   %edx
    3355:	52                   	push   %edx
    3356:	68 71 58 00 00       	push   $0x5871
    335b:	ff 35 a0 71 00 00    	pushl  0x71a0
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    337b:	68 9f 58 00 00       	push   $0x589f
    3380:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3418:	50                   	push   %eax
    3419:	68 ac 58 00 00       	push   $0x58ac
    341e:	6a 01                	push   $0x1
    ...
    3452:	68 80 99 00 00       	push   $0x9980
    3457:	57                   	push   %edi
    ...
    346a:	56                   	push   %esi
    346b:	68 c8 58 00 00       	push   $0x58c8
    3470:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3494:	50                   	push   %eax
    3495:	68 b8 58 00 00       	push   $0x58b8
    349a:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    3548:	68 d8 58 00 00       	push   $0x58d8
    354d:	6a 01                	push   $0x1
...
uio()
{
  ...
  printf(1, "uio test\n");
    3566:	68 ee 58 00 00       	push   $0x58ee
    356b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3588:	68 f8 58 00 00       	push   $0x58f8
    358d:	6a 01                	push   $0x1
  ...
  if(pid == 0){
    ...
    35aa:	52                   	push   %edx
    35ab:	52                   	push   %edx
    35ac:	68 84 60 00 00       	push   $0x6084
    35b1:	6a 01                	push   $0x1
    ...
    35bd:	50                   	push   %eax
    35be:	50                   	push   %eax
    35bf:	68 7d 58 00 00       	push   $0x587d
    35c4:	6a 01                	push   $0x1
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    35d7:	6a 00                	push   $0x0
    35d9:	68 07 59 00 00       	push   $0x5907
  ...
  printf(1, "arg test passed\n");
    360d:	58                   	pop    %eax
    360e:	5a                   	pop    %edx
    360f:	68 19 59 00 00       	push   $0x5919
    3614:	6a 01                	push   $0x1
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    3623:	51                   	push   %ecx
    3624:	51                   	push   %ecx
    3625:	68 0c 59 00 00       	push   $0x590c
    362a:	6a 02                	push   $0x2
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    3640:	69 05 9c 71 00 00 0d 	imul   $0x19660d,0x719c,%eax
    3647:	66 19 00 
}
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    ...
    3653:	a3 9c 71 00 00       	mov    %eax,0x719c
  return randstate;
}
    3658:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    39af:	f7 f6                	div    %esi
    39b1:	0f b6 92 dc 60 00 00 	movzbl 0x60dc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3b28:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    3b2b:	b8 d2 60 00 00       	mov    $0x60d2,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bb1:	a1 40 72 00 00       	mov    0x7240,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    3c09:	a3 40 72 00 00       	mov    %eax,0x7240
}
    3c0e:	5b                   	pop    %ebx
    3c0f:	5e                   	pop    %esi
    3c10:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    3c2d:	a3 40 72 00 00       	mov    %eax,0x7240
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c4c:	8b 15 40 72 00 00    	mov    0x7240,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3ca1:	39 05 40 72 00 00    	cmp    %eax,0x7240
  ...
  return freep;
    3ccb:	8b 15 40 72 00 00    	mov    0x7240,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3cec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
    3cef:	89 15 40 72 00 00    	mov    %edx,0x7240
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3d06:	c7 05 40 72 00 00 44 	movl   $0x7244,0x7240
    3d0d:	72 00 00 
    3d10:	c7 05 44 72 00 00 44 	movl   $0x7244,0x7244
    3d17:	72 00 00 
    base.s.size = 0;
    3d1a:	b8 44 72 00 00       	mov    $0x7244,%eax
    3d1f:	c7 05 48 72 00 00 00 	movl   $0x0,0x7248
    3d26:	00 00 00 
...
run_thread(void (*start_func)(void *), void*arg)
{
    ...
    3d33:	56                   	push   %esi
    3d34:	53                   	push   %ebx
    3d35:	8b 75 0c             	mov    0xc(%ebp),%esi
    3d38:	8b 5d 08             	mov    0x8(%ebp),%ebx
  printf(1, "---- running the function ----\n");
    3d3b:	83 ec 08             	sub    $0x8,%esp
    3d3e:	68 f0 60 00 00       	push   $0x60f0
    3d43:	6a 01                	push   $0x1
    3d45:	e8 c6 fc ff ff       	call   3a10 <printf>
  alarm(UTHREAD_QUANTA);
    3d4a:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    3d51:	e8 04 fc ff ff       	call   395a <alarm>
  start_func(arg);
    3d56:	89 75 08             	mov    %esi,0x8(%ebp)
    3d59:	83 c4 10             	add    $0x10,%esp
}
    3d5c:	8d 65 f8             	lea    -0x8(%ebp),%esp
void
run_thread(void (*start_func)(void *), void*arg)
{
  printf(1, "---- running the function ----\n");
...
init_bsem()
{
  for(int i = 0; i <MAX_BSEM; i++) {
    binSemaphore[i].state = UNUSED;
	for (int j=0;j<MAX_UTHREADS;j++){
    3d99:	39 d0                	cmp    %edx,%eax
    3d9b:	75 f3                	jne    3d90 <init_bsem+0x20>
    3d9d:	8d 90 0c 01 00 00    	lea    0x10c(%eax),%edx
int first_run_bsem = 0; // if 0 then first run
...
{
  for(int i = 0; i <MAX_BSEM; i++) {
    3da3:	81 fa c8 49 01 00    	cmp    $0x149c8,%edx
    3da9:	75 d5                	jne    3d80 <init_bsem+0x10>
	for (int j=0;j<MAX_UTHREADS;j++){
    binSemaphore[i].sleep[j] = -1;
	 }
  }
  ...
  first_run_bsem=1;
    3dab:	c7 05 4c 72 00 00 01 	movl   $0x1,0x724c
    3db2:	00 00 00 
}
    3db5:	5d                   	pop    %ebp
    3db6:	c3                   	ret    
...
int bsem_alloc() {
  ...
  alarm(0);
    ...
    3dc8:	6a 00                	push   $0x0
    3dca:	e8 8b fb ff ff       	call   395a <alarm>
  int i;
  if(first_run_bsem == 0)
    3dcf:	a1 4c 72 00 00       	mov    0x724c,%eax
    3dd4:	83 c4 10             	add    $0x10,%esp
    3dd7:	85 c0                	test   %eax,%eax
    3dd9:	75 3a                	jne    3e15 <bsem_alloc+0x55>
    3ddb:	ba c8 c3 00 00       	mov    $0xc3c8,%edx
    3de0:	8d 82 00 ff ff ff    	lea    -0x100(%edx),%eax
...
init_bsem()
{
  for(int i = 0; i <MAX_BSEM; i++) {
    binSemaphore[i].state = UNUSED;
    3de6:	c7 02 01 00 00 00    	movl   $0x1,(%edx)
    3dec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	for (int j=0;j<MAX_UTHREADS;j++){
    binSemaphore[i].sleep[j] = -1;
    3df0:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
    3df6:	83 c0 04             	add    $0x4,%eax
void
init_bsem()
{
  for(int i = 0; i <MAX_BSEM; i++) {
    binSemaphore[i].state = UNUSED;
	for (int j=0;j<MAX_UTHREADS;j++){
    3df9:	39 d0                	cmp    %edx,%eax
    3dfb:	75 f3                	jne    3df0 <bsem_alloc+0x30>
    3dfd:	8d 90 0c 01 00 00    	lea    0x10c(%eax),%edx
int first_run_bsem = 0; // if 0 then first run
...
{
  for(int i = 0; i <MAX_BSEM; i++) {
    3e03:	81 fa c8 49 01 00    	cmp    $0x149c8,%edx
    3e09:	75 d5                	jne    3de0 <bsem_alloc+0x20>
	for (int j=0;j<MAX_UTHREADS;j++){
    binSemaphore[i].sleep[j] = -1;
	 }
  }
  //printf(1,"done init binary semaphore!\n");
  first_run_bsem=1;
    3e0b:	c7 05 4c 72 00 00 01 	movl   $0x1,0x724c
    3e12:	00 00 00 
    3e15:	ba c8 c3 00 00       	mov    $0xc3c8,%edx
  if(first_run_bsem == 0)
  {
    init_bsem();
  }
  ...
  for(i = 0; i <MAX_BSEM; i++) {
    ...
    3e1c:	eb 10                	jmp    3e2e <bsem_alloc+0x6e>
    3e1e:	83 c0 01             	add    $0x1,%eax
    3e21:	81 c2 0c 01 00 00    	add    $0x10c,%edx
    3e27:	3d 80 00 00 00       	cmp    $0x80,%eax
    3e2c:	74 61                	je     3e8f <bsem_alloc+0xcf>
    if(binSemaphore[i].state == UNUSED)
    3e2e:	83 3a 01             	cmpl   $0x1,(%edx)
    3e31:	75 eb                	jne    3e1e <bsem_alloc+0x5e>
    break;
  }
  if (i<MAX_BSEM){
    binSemaphore[i].id = binSemCounter;
    3e33:	8b 15 b8 71 00 00    	mov    0x71b8,%edx
    3e39:	69 c8 0c 01 00 00    	imul   $0x10c,%eax,%ecx
    binSemCounter++;
  ...
  if (i<MAX_BSEM){
    binSemaphore[i].id = binSemCounter;
    3e44:	8d 99 c0 c2 00 00    	lea    0xc2c0(%ecx),%ebx
    binSemCounter++;
    binSemaphore[i].lock = 1; // not locked
    binSemaphore[i].state = USED;
    printf(1,"initialize semaphore in index %d, with id %d\n",i,binSemCounter-1);
    3e4a:	68 10 61 00 00       	push   $0x6110
    3e4f:	6a 01                	push   $0x1
  for(i = 0; i <MAX_BSEM; i++) {
    if(binSemaphore[i].state == UNUSED)
    break;
  ...
  if (i<MAX_BSEM){
    binSemaphore[i].id = binSemCounter;
    3e51:	89 91 c4 c2 00 00    	mov    %edx,0xc2c4(%ecx)
    binSemCounter++;
    3e57:	89 35 b8 71 00 00    	mov    %esi,0x71b8
    binSemaphore[i].lock = 1; // not locked
    3e5d:	c7 81 c0 c2 00 00 01 	movl   $0x1,0xc2c0(%ecx)
    3e64:	00 00 00 
    binSemaphore[i].state = USED;
    3e67:	c7 81 c8 c3 00 00 00 	movl   $0x0,0xc3c8(%ecx)
    3e6e:	00 00 00 
    printf(1,"initialize semaphore in index %d, with id %d\n",i,binSemCounter-1);
    3e71:	e8 9a fb ff ff       	call   3a10 <printf>
    alarm(UTHREAD_QUANTA);
    3e76:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    3e7d:	e8 d8 fa ff ff       	call   395a <alarm>
    return binSemaphore[i].id;
    3e82:	8b 43 04             	mov    0x4(%ebx),%eax
    3e85:	83 c4 10             	add    $0x10,%esp
    ...
    3e92:	68 40 61 00 00       	push   $0x6140
    3e97:	6a 01                	push   $0x1
    3e99:	e8 72 fb ff ff       	call   3a10 <printf>
    alarm(UTHREAD_QUANTA);
    3e9e:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    3ea5:	e8 b0 fa ff ff       	call   395a <alarm>
    return -1;
    3eaa:	83 c4 10             	add    $0x10,%esp
  }
}
    3ead:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return binSemaphore[i].id;
  }
  else{	//all semaphores are used
    printf(1,"all semaphores are being used\n");
    alarm(UTHREAD_QUANTA);
    return -1;
    3eb0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  }
}
    3eb5:	5b                   	pop    %ebx
    3eb6:	5e                   	pop    %esi
...
void bsem_free(int id) {
    ...
    3ec3:	53                   	push   %ebx
    3ec4:	83 ec 10             	sub    $0x10,%esp
    3ec7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  alarm(0);
    3eca:	6a 00                	push   $0x0
    3ecc:	e8 89 fa ff ff       	call   395a <alarm>
    3ed1:	ba c4 c2 00 00       	mov    $0xc2c4,%edx
    3ed6:	83 c4 10             	add    $0x10,%esp
  int i;
  /* search for the Semaphore */
  for(i = 0; i <MAX_BSEM; i++) {
    3ed9:	31 c0                	xor    %eax,%eax
    3edb:	eb 13                	jmp    3ef0 <bsem_free+0x30>
    3edd:	8d 76 00             	lea    0x0(%esi),%esi
    3ee0:	83 c0 01             	add    $0x1,%eax
    3ee3:	81 c2 0c 01 00 00    	add    $0x10c,%edx
    3ee9:	3d 80 00 00 00       	cmp    $0x80,%eax
    3eee:	74 48                	je     3f38 <bsem_free+0x78>
    if(binSemaphore[i].id == id) {
    3ef0:	39 1a                	cmp    %ebx,(%edx)
    3ef2:	75 ec                	jne    3ee0 <bsem_free+0x20>
      if (binSemaphore[i].state == UNUSED) {
    3ef4:	69 d0 0c 01 00 00    	imul   $0x10c,%eax,%edx
    3efa:	81 c2 c0 c2 00 00    	add    $0xc2c0,%edx
    3f00:	83 ba 08 01 00 00 01 	cmpl   $0x1,0x108(%edx)
    3f07:	74 52                	je     3f5b <bsem_free+0x9b>
      break;
    }
  }
  /* Semaphore is found*/
  if (i<MAX_BSEM){
    binSemaphore[i].state = UNUSED;
    3f09:	c7 82 08 01 00 00 01 	movl   $0x1,0x108(%edx)
    3f10:	00 00 00 
    printf(1,"binary semaphore with index %d with id %d is now unused \n",i, id);
    3f13:	53                   	push   %ebx
    3f14:	50                   	push   %eax
    3f15:	68 a0 61 00 00       	push   $0x61a0
    3f1a:	6a 01                	push   $0x1
    3f1c:	e8 ef fa ff ff       	call   3a10 <printf>
    3f21:	83 c4 10             	add    $0x10,%esp
  }
  else
  printf(1,"can't find id %d\n",id);
  alarm(UTHREAD_QUANTA);
    3f24:	c7 45 08 05 00 00 00 	movl   $0x5,0x8(%ebp)
}
    3f2b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3f2e:	c9                   	leave  
    binSemaphore[i].state = UNUSED;
    printf(1,"binary semaphore with index %d with id %d is now unused \n",i, id);
  }
  ...
  printf(1,"can't find id %d\n",id);
  alarm(UTHREAD_QUANTA);
    3f2f:	e9 26 fa ff ff       	jmp    395a <alarm>
  ...
  printf(1,"can't find id %d\n",id);
    ...
    3f3b:	53                   	push   %ebx
    3f3c:	68 e0 64 00 00       	push   $0x64e0
    3f41:	6a 01                	push   $0x1
    3f43:	e8 c8 fa ff ff       	call   3a10 <printf>
    3f48:	83 c4 10             	add    $0x10,%esp
  alarm(UTHREAD_QUANTA);
    3f4b:	c7 45 08 05 00 00 00 	movl   $0x5,0x8(%ebp)
}
    3f52:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3f55:	c9                   	leave  
    binSemaphore[i].state = UNUSED;
    printf(1,"binary semaphore with index %d with id %d is now unused \n",i, id);
  }
  ...
  printf(1,"can't find id %d\n",id);
  alarm(UTHREAD_QUANTA);
    3f56:	e9 ff f9 ff ff       	jmp    395a <alarm>
  int i;
  /* search for the Semaphore */
  for(i = 0; i <MAX_BSEM; i++) {
    if(binSemaphore[i].id == id) {
    ...
    3f5b:	53                   	push   %ebx
    3f5c:	50                   	push   %eax
    3f5d:	68 60 61 00 00       	push   $0x6160
    3f62:	6a 01                	push   $0x1
    3f64:	e8 a7 fa ff ff       	call   3a10 <printf>
        alarm(UTHREAD_QUANTA);
    3f69:	83 c4 10             	add    $0x10,%esp
    3f6c:	c7 45 08 05 00 00 00 	movl   $0x5,0x8(%ebp)
    printf(1,"binary semaphore with index %d with id %d is now unused \n",i, id);
  }
  else
  printf(1,"can't find id %d\n",id);
  ...
  for(i = 0; i <MAX_BSEM; i++) {
    if(binSemaphore[i].id == id) {
      if (binSemaphore[i].state == UNUSED) {
        printf(1,"binary semaphore in index %d, with id %d is already unused!\n",i,id);
        alarm(UTHREAD_QUANTA);
    3f77:	e9 de f9 ff ff       	jmp    395a <alarm>
...
void bsem_up(int id) {
    3f88:	83 ec 28             	sub    $0x28,%esp
    3f8b:	8b 75 08             	mov    0x8(%ebp),%esi
  alarm(0);
    3f8e:	6a 00                	push   $0x0
    3f90:	e8 c5 f9 ff ff       	call   395a <alarm>
    3f95:	b8 c4 c2 00 00       	mov    $0xc2c4,%eax
    3f9a:	83 c4 10             	add    $0x10,%esp
    3f9d:	eb 15                	jmp    3fb4 <bsem_up+0x34>
    3f9f:	90                   	nop
  int i;
  /* searching for Semaphore */
  for(i = 0; i <MAX_BSEM; i++) {
    3fa0:	83 c3 01             	add    $0x1,%ebx
    3fa3:	05 0c 01 00 00       	add    $0x10c,%eax
    3fa8:	81 fb 80 00 00 00    	cmp    $0x80,%ebx
    3fae:	0f 84 04 01 00 00    	je     40b8 <bsem_up+0x138>
    if(binSemaphore[i].id == id && binSemaphore[i].state == USED)
    3fb4:	39 30                	cmp    %esi,(%eax)
    3fb6:	75 e8                	jne    3fa0 <bsem_up+0x20>
    3fb8:	8b 90 04 01 00 00    	mov    0x104(%eax),%edx
    3fbe:	85 d2                	test   %edx,%edx
    3fc0:	75 de                	jne    3fa0 <bsem_up+0x20>
      break;
	  }
  }
  /* found */
  if (i<MAX_BSEM){
    ...
    3fc2:	69 c3 0c 01 00 00    	imul   $0x10c,%ebx,%eax
    3fc8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3fcb:	8b 80 c0 c2 00 00    	mov    0xc2c0(%eax),%eax
    3fd1:	85 c0                	test   %eax,%eax
    3fd3:	0f 85 8e 00 00 00    	jne    4067 <bsem_up+0xe7>
      printf(1, "thread %d want to free semaphore with id %d \n",threads[index_currently_running].thread_id, id);
    3fd9:	a1 c4 48 01 00       	mov    0x148c4,%eax
    3fde:	56                   	push   %esi
    3fdf:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    3fe2:	ff 34 85 a0 b9 00 00 	pushl  0xb9a0(,%eax,4)
    3fe9:	68 dc 61 00 00       	push   $0x61dc
    3fee:	6a 01                	push   $0x1
    3ff0:	e8 1b fa ff ff       	call   3a10 <printf>
      int j;
      for (j=0;j<MAX_UTHREADS;j++){
    3ff5:	31 c0                	xor    %eax,%eax
    3ff7:	89 75 e0             	mov    %esi,-0x20(%ebp)
    3ffa:	83 c4 10             	add    $0x10,%esp
    3ffd:	89 c6                	mov    %eax,%esi
        if (binSemaphore[i].sleep[j] != -1){
    3fff:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4002:	8b bc b0 c8 c2 00 00 	mov    0xc2c8(%eax,%esi,4),%edi
    4009:	83 ff ff             	cmp    $0xffffffff,%edi
    400c:	74 72                	je     4080 <bsem_up+0x100>
    400e:	ba a0 b9 00 00       	mov    $0xb9a0,%edx
    4013:	31 c0                	xor    %eax,%eax
    4015:	eb 14                	jmp    402b <bsem_up+0xab>
    ...
    4023:	83 c2 24             	add    $0x24,%edx
    4026:	83 f8 40             	cmp    $0x40,%eax
    4029:	74 55                	je     4080 <bsem_up+0x100>
    ...
    402b:	8b 0a                	mov    (%edx),%ecx
    402d:	83 f9 ff             	cmp    $0xffffffff,%ecx
    4030:	74 ee                	je     4020 <bsem_up+0xa0>
    4032:	39 cf                	cmp    %ecx,%edi
    4034:	75 ea                	jne    4020 <bsem_up+0xa0>
              threads[h].state=RUNNABLE_THREAD;
    4036:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    4039:	c7 04 85 a8 b9 00 00 	movl   $0x2,0xb9a8(,%eax,4)
    4040:	02 00 00 00 
              binSemaphore[i].sleep[j] =- 1;
    4044:	6b c3 43             	imul   $0x43,%ebx,%eax
    4047:	01 f0                	add    %esi,%eax
    4049:	c7 04 85 c8 c2 00 00 	movl   $0xffffffff,0xc2c8(,%eax,4)
    4050:	ff ff ff ff 
    }
  }
  /* didnt found */
  ...
  alarm(UTHREAD_QUANTA);
    4054:	c7 45 08 05 00 00 00 	movl   $0x5,0x8(%ebp)

}
    405b:	8d 65 f4             	lea    -0xc(%ebp),%esp
    405e:	5b                   	pop    %ebx
    405f:	5e                   	pop    %esi
    4060:	5f                   	pop    %edi
    4061:	5d                   	pop    %ebp
  ...
  /* didnt found */
    ...
    printf(1,"you tried to free a binary semaphore that does not exist! (id: %d)\n", id);
  alarm(UTHREAD_QUANTA);
    4062:	e9 f3 f8 ff ff       	jmp    395a <alarm>
    ...
    406a:	68 0c 62 00 00       	push   $0x620c
    406f:	6a 01                	push   $0x1
    4071:	e8 9a f9 ff ff       	call   3a10 <printf>
    4076:	83 c4 10             	add    $0x10,%esp
    4079:	eb d9                	jmp    4054 <bsem_up+0xd4>
    407b:	90                   	nop
    407c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  /* found */
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 0) { //lock is taken
      printf(1, "thread %d want to free semaphore with id %d \n",threads[index_currently_running].thread_id, id);
      int j;
      for (j=0;j<MAX_UTHREADS;j++){
    4080:	83 c6 01             	add    $0x1,%esi
    4083:	83 fe 40             	cmp    $0x40,%esi
    4086:	0f 85 73 ff ff ff    	jne    3fff <bsem_up+0x7f>
    408c:	8b 75 e0             	mov    -0x20(%ebp),%esi
        }
      }
	  cont:
      if(j  == MAX_UTHREADS){
	  ...
	  printf(1,"semaphore %d is now free!\n",id);
    408f:	83 ec 04             	sub    $0x4,%esp
        binSemaphore[i].lock = 1;
    4092:	69 db 0c 01 00 00    	imul   $0x10c,%ebx,%ebx
        }
      }
	  cont:
      if(j  == MAX_UTHREADS){
	  ...
	  printf(1,"semaphore %d is now free!\n",id);
    4098:	56                   	push   %esi
    4099:	68 f2 64 00 00       	push   $0x64f2
    409e:	6a 01                	push   $0x1
    40a0:	e8 6b f9 ff ff       	call   3a10 <printf>
        binSemaphore[i].lock = 1;
    40a5:	c7 83 c0 c2 00 00 01 	movl   $0x1,0xc2c0(%ebx)
    40ac:	00 00 00 
    40af:	83 c4 10             	add    $0x10,%esp
    40b2:	eb a0                	jmp    4054 <bsem_up+0xd4>
  ...
  /* didnt found */
    ...
    printf(1,"you tried to free a binary semaphore that does not exist! (id: %d)\n", id);
    40b8:	83 ec 04             	sub    $0x4,%esp
    40bb:	56                   	push   %esi
    40bc:	68 30 62 00 00       	push   $0x6230
    40c1:	6a 01                	push   $0x1
    40c3:	e8 48 f9 ff ff       	call   3a10 <printf>
    40c8:	83 c4 10             	add    $0x10,%esp
    40cb:	eb 87                	jmp    4054 <bsem_up+0xd4>
    40cd:	8d 76 00             	lea    0x0(%esi),%esi

000040d0 <uthread_init>:
  start_func(arg);
}
...
uthread_init()
{
    ...
    40d3:	83 ec 10             	sub    $0x10,%esp
  printf(1, "-------initializing the threads -------\n");
    40d6:	68 74 62 00 00       	push   $0x6274
    40db:	6a 01                	push   $0x1
    40dd:	e8 2e f9 ff ff       	call   3a10 <printf>
    40e2:	b8 a0 b9 00 00       	mov    $0xb9a0,%eax
    40e7:	83 c4 10             	add    $0x10,%esp
    40ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

  // Initializes the processג€™ threads table
  for(int i = 0 ; i < MAX_UTHREADS ; i++)
  {
    threads[i].thread_id = -1; // if the thread is unused there is no id
    40f0:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
    threads[i].state = UNUSED_THREAD;
    40f6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    40fd:	83 c0 24             	add    $0x24,%eax
    threads[i].ebp = 0;
    4100:	c7 40 e8 00 00 00 00 	movl   $0x0,-0x18(%eax)
    threads[i].esp = 0;
    4107:	c7 40 ec 00 00 00 00 	movl   $0x0,-0x14(%eax)
    threads[i].time_to_get_up = 0;
    410e:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    threads[i].join=-1;
    4115:	c7 40 fc ff ff ff ff 	movl   $0xffffffff,-0x4(%eax)
uthread_init()
{
  printf(1, "-------initializing the threads -------\n");
  ...
  // Initializes the processג€™ threads table
  for(int i = 0 ; i < MAX_UTHREADS ; i++)
    411c:	3d a0 c2 00 00       	cmp    $0xc2a0,%eax
    4121:	75 cd                	jne    40f0 <uthread_init+0x20>
  ...
  threads[0].thread_id = 0;
    4126:	c7 05 a0 b9 00 00 00 	movl   $0x0,0xb9a0
    412d:	00 00 00 
  threads[0].state = RUNNING_THREAD;
    4130:	c7 05 a8 b9 00 00 03 	movl   $0x3,0xb9a8
    4137:	00 00 00 
  ...
  // Registers the SIGALRM handler to the uthread_schedule function
  signal(14,  (sighandler_t)(uthread_schedule));
    413a:	68 10 43 00 00       	push   $0x4310
    413f:	6a 0e                	push   $0xe
    threads[i].join=-1;
  }
  //  Creates the main thread
  ...
  threads[0].state = RUNNING_THREAD;
  threads[0].stack = 0;
    4141:	c7 05 a4 b9 00 00 00 	movl   $0x0,0xb9a4
    4148:	00 00 00 

  id_number_thread = 1;
    414b:	c7 05 c0 48 01 00 01 	movl   $0x1,0x148c0
    4152:	00 00 00 
  index_currently_running = 0;
    4155:	c7 05 c4 48 01 00 00 	movl   $0x0,0x148c4
    415c:	00 00 00 
  currently_running = 0;
    415f:	c7 05 a0 c2 00 00 00 	movl   $0x0,0xc2a0
    4166:	00 00 00 
  // Registers the SIGALRM handler to the uthread_schedule function
  signal(14,  (sighandler_t)(uthread_schedule));
    4169:	e8 d4 f7 ff ff       	call   3942 <signal>

  // Executes the alarm system call with parameter UTHREAD_QUANTA=5
  alarm(UTHREAD_QUANTA);
    416e:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    4175:	e8 e0 f7 ff ff       	call   395a <alarm>
  return 0;
}
...
uthread_create(void (*start_func)(void *), void*arg)
{
    ...
    4184:	53                   	push   %ebx
  alarm(0);
    4185:	83 ec 0c             	sub    $0xc,%esp
    4188:	6a 00                	push   $0x0
    418a:	e8 cb f7 ff ff       	call   395a <alarm>
  printf(1, "------ creating a new thread ------\n");
    418f:	5b                   	pop    %ebx
    4190:	5e                   	pop    %esi
    4191:	68 a0 62 00 00       	push   $0x62a0
    4196:	6a 01                	push   $0x1
    4198:	e8 73 f8 ff ff       	call   3a10 <printf>
    419d:	ba a8 b9 00 00       	mov    $0xb9a8,%edx
    41a2:	83 c4 10             	add    $0x10,%esp
  /* serching for an empty process*/
  int free_thread = -1;
  for(int i = 0; i < MAX_UTHREADS ; i++)
    41a5:	31 c0                	xor    %eax,%eax
    41a7:	eb 12                	jmp    41bb <uthread_create+0x3b>
    41a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    41b0:	83 c0 01             	add    $0x1,%eax
    41b3:	83 c2 24             	add    $0x24,%edx
    41b6:	83 f8 40             	cmp    $0x40,%eax
    41b9:	74 7d                	je     4238 <uthread_create+0xb8>
  {
    if(threads[i].state == UNUSED_THREAD)
    41bb:	8b 0a                	mov    (%edx),%ecx
    41bd:	85 c9                	test   %ecx,%ecx
    41bf:	75 ef                	jne    41b0 <uthread_create+0x30>
  ...
  threads[free_thread].thread_id = id_number_thread;
    41c1:	8b 15 c0 48 01 00    	mov    0x148c0,%edx
    41c7:	8d 1c c0             	lea    (%eax,%eax,8),%ebx
  id_number_thread++;

  /* creating the stack */
  threads[free_thread].stack = malloc(UTHREAD_STACK_SIZE);
    41ca:	83 ec 0c             	sub    $0xc,%esp
    41cd:	68 00 10 00 00       	push   $0x1000
    printf(1, "there is no available thread\n");
    alarm(UTHREAD_QUANTA);
    return -1;
  }
  /* naming the thread */
  threads[free_thread].thread_id = id_number_thread;
    41d2:	c1 e3 02             	shl    $0x2,%ebx
    41d5:	89 93 a0 b9 00 00    	mov    %edx,0xb9a0(%ebx)
  id_number_thread++;
    41db:	83 c2 01             	add    $0x1,%edx
    41de:	89 15 c0 48 01 00    	mov    %edx,0x148c0

  /* creating the stack */
  threads[free_thread].stack = malloc(UTHREAD_STACK_SIZE);
    41e4:	e8 57 fa ff ff       	call   3c40 <malloc>
  ...
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 2*sizeof(int))) = (int)start_func;
  ...
  /* initializing the stack */
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 3*sizeof(int))) = (int)uthread_exit;
    41ec:	c7 80 f4 0f 00 00 10 	movl   $0x4610,0xff4(%eax)
    41f3:	46 00 00 
  /* naming the thread */
  threads[free_thread].thread_id = id_number_thread;
  id_number_thread++;
  ...
  /* creating the stack */
  threads[free_thread].stack = malloc(UTHREAD_STACK_SIZE);
    41f6:	89 83 a4 b9 00 00    	mov    %eax,0xb9a4(%ebx)
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 3*sizeof(int))) = (int)uthread_exit;
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 2*sizeof(int))) = (int)start_func;
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - sizeof(int))) = (int)arg;
  ...
  threads[free_thread].state = RUNNABLE_THREAD;
    41fc:	c7 83 a8 b9 00 00 02 	movl   $0x2,0xb9a8(%ebx)
    4203:	00 00 00 
  /* creating the stack */
  threads[free_thread].stack = malloc(UTHREAD_STACK_SIZE);
  ...
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 3*sizeof(int))) = (int)uthread_exit;
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 2*sizeof(int))) = (int)start_func;
    4206:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - sizeof(int))) = (int)arg;
    420c:	8b 55 0c             	mov    0xc(%ebp),%edx
    420f:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  ...
  alarm(UTHREAD_QUANTA);
    4215:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    421c:	e8 39 f7 ff ff       	call   395a <alarm>
  return   threads[free_thread].thread_id;
    4221:	8b 83 a0 b9 00 00    	mov    0xb9a0(%ebx),%eax
    4227:	83 c4 10             	add    $0x10,%esp
}
    422a:	8d 65 f8             	lea    -0x8(%ebp),%esp
    422d:	5b                   	pop    %ebx
    422e:	5e                   	pop    %esi
    422f:	5d                   	pop    %ebp
    4230:	c3                   	ret    
  ...
  if(free_thread == -1){
    printf(1, "there is no available thread\n");
    4238:	83 ec 08             	sub    $0x8,%esp
    423b:	68 0d 65 00 00       	push   $0x650d
    4240:	6a 01                	push   $0x1
    4242:	e8 c9 f7 ff ff       	call   3a10 <printf>
    alarm(UTHREAD_QUANTA);
    4247:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    424e:	e8 07 f7 ff ff       	call   395a <alarm>
    return -1;
  ...
  if(free_thread == -1){
    ...
    alarm(UTHREAD_QUANTA);
    return -1;
    4259:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  threads[free_thread].state = RUNNABLE_THREAD;
  ...
  return   threads[free_thread].thread_id;
    ...
    4260:	5d                   	pop    %ebp
    4261:	c3                   	ret    
    4262:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    4269:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00004270 <contexSwitch>:
...
void contexSwitch(int prev_index,int next){
  ...
  printf(1, "prev is : %d next is : %d\n", prev_index, next);
    ...
    427d:	53                   	push   %ebx
    427e:	68 2b 65 00 00       	push   $0x652b
    4283:	6a 01                	push   $0x1
    4285:	e8 86 f7 ff ff       	call   3a10 <printf>
 // printf(1, "prev state is : %d next state is : %d\n", (int)(threads[prev_index].state), (int)(threads[next].state));
  if (threads[prev_index].state == RUNNING_THREAD && prev_index!=0){
    428a:	8d 04 db             	lea    (%ebx,%ebx,8),%eax
    428d:	83 c4 10             	add    $0x10,%esp
    4290:	8d 04 85 a0 b9 00 00 	lea    0xb9a0(,%eax,4),%eax
    4297:	83 78 08 03          	cmpl   $0x3,0x8(%eax)
    429b:	74 33                	je     42d0 <contexSwitch+0x60>
    //printf(1, "%d\n",(int)threads[prev_index].state );
    threads[prev_index].state = RUNNABLE_THREAD;
  }

  if (prev_index!=0 ){
    429d:	85 db                	test   %ebx,%ebx
    429f:	75 3a                	jne    42db <contexSwitch+0x6b>
  ...
  threads[index_currently_running].state = RUNNING_THREAD;
    42a1:	a1 c4 48 01 00       	mov    0x148c4,%eax
    42a6:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    42a9:	8d 04 85 a0 b9 00 00 	lea    0xb9a0(,%eax,4),%eax
  if(threads[index_currently_running].esp == 0) // the process is new, need to load the function
    42b0:	8b 50 10             	mov    0x10(%eax),%edx
    asm("movl %%esp, %0;" : "=r" (threads[prev_index].esp));
    asm("movl %%ebp, %0;" : "=r" (threads[prev_index].ebp));
  }
  ...
  /* loading the new thread*/
  threads[index_currently_running].state = RUNNING_THREAD;
    42b3:	c7 40 08 03 00 00 00 	movl   $0x3,0x8(%eax)
  if(threads[index_currently_running].esp == 0) // the process is new, need to load the function
    42ba:	85 d2                	test   %edx,%edx
    42bc:	74 3a                	je     42f8 <contexSwitch+0x88>
    ...
    42be:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (threads[index_currently_running].ebp));
    42c0:	8b 40 0c             	mov    0xc(%eax),%eax
    42c3:	89 c5                	mov    %eax,%ebp
  }
  return;
}
    42c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    42c8:	c9                   	leave  
    42c9:	c3                   	ret    
...
void contexSwitch(int prev_index,int next){
 ...
 // printf(1, "prev state is : %d next state is : %d\n", (int)(threads[prev_index].state), (int)(threads[next].state));
  if (threads[prev_index].state == RUNNING_THREAD && prev_index!=0){
    42d0:	85 db                	test   %ebx,%ebx
    42d2:	74 cd                	je     42a1 <contexSwitch+0x31>
    //printf(1, "%d\n",(int)threads[prev_index].state );
    threads[prev_index].state = RUNNABLE_THREAD;
    42d4:	c7 40 08 02 00 00 00 	movl   $0x2,0x8(%eax)
  }
  ...
  if (prev_index!=0 ){
    ...
    asm("movl %%esp, %0;" : "=r" (threads[prev_index].esp));
    42db:	8d 04 db             	lea    (%ebx,%ebx,8),%eax
    42de:	89 e2                	mov    %esp,%edx
    42e0:	8d 04 85 a0 b9 00 00 	lea    0xb9a0(,%eax,4),%eax
    42e7:	89 50 10             	mov    %edx,0x10(%eax)
    asm("movl %%ebp, %0;" : "=r" (threads[prev_index].ebp));
    42ea:	89 ea                	mov    %ebp,%edx
    42ec:	89 50 0c             	mov    %edx,0xc(%eax)
    42ef:	eb b0                	jmp    42a1 <contexSwitch+0x31>
  ...
  if(threads[index_currently_running].esp == 0) // the process is new, need to load the function
  {
    ...
    42fb:	05 f4 0f 00 00       	add    $0xff4,%eax
    4300:	89 c4                	mov    %eax,%esp
    asm("movl %0, %%ebp;" : : "r" (threads[index_currently_running].stack + UTHREAD_STACK_SIZE - 3*sizeof(int)));
    4302:	89 c5                	mov    %eax,%ebp
    asm("jmp *%0 ;" : : "r" (run_thread));
    4304:	b8 30 3d 00 00       	mov    $0x3d30,%eax
    4309:	ff e0                	jmp    *%eax
    //printf(1,"proc is old\n");
    asm("movl %0, %%esp;" : : "r" (threads[index_currently_running].esp));
    asm("movl %0, %%ebp;" : : "r" (threads[index_currently_running].ebp));
...
uthread_schedule()
{
  ...
  alarm(0); // disabling alarm - don't want interrupts
    4319:	6a 00                	push   $0x0
    431b:	e8 3a f6 ff ff       	call   395a <alarm>
  printf(1, "------ scheduleing ------\n");
    4320:	59                   	pop    %ecx
    4321:	5b                   	pop    %ebx
    4322:	68 46 65 00 00       	push   $0x6546
    4327:	6a 01                	push   $0x1
    4329:	bb a8 b9 00 00       	mov    $0xb9a8,%ebx
    432e:	e8 dd f6 ff ff       	call   3a10 <printf>
    4333:	83 c4 10             	add    $0x10,%esp
    4336:	eb 13                	jmp    434b <uthread_schedule+0x3b>
    4338:	90                   	nop
    4339:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    4340:	83 c3 24             	add    $0x24,%ebx
  int sleeping=0;
  /* check if there any process to wake up*/
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    4343:	81 fb a8 c2 00 00    	cmp    $0xc2a8,%ebx
    4349:	74 55                	je     43a0 <uthread_schedule+0x90>
    if(threads[i].state == SLEEPING_THREAD && threads[i].time_to_get_up!=0 && threads[i].time_to_get_up <= uptime()){
    434b:	83 3b 01             	cmpl   $0x1,(%ebx)
    434e:	75 f0                	jne    4340 <uthread_schedule+0x30>
    4350:	8b 73 14             	mov    0x14(%ebx),%esi
    4353:	85 f6                	test   %esi,%esi
    4355:	0f 85 a5 00 00 00    	jne    4400 <uthread_schedule+0xf0>
    ...
    435b:	8b 43 18             	mov    0x18(%ebx),%eax
    435e:	83 f8 ff             	cmp    $0xffffffff,%eax
    4361:	74 dd                	je     4340 <uthread_schedule+0x30>
    4363:	8d 14 c0             	lea    (%eax,%eax,8),%edx
    4366:	8b 14 95 a8 b9 00 00 	mov    0xb9a8(,%edx,4),%edx
    436d:	85 d2                	test   %edx,%edx
    436f:	75 cf                	jne    4340 <uthread_schedule+0x30>
      printf(1,"thread %d waited for %d now i woke up! !@!@@!\n",threads[i].thread_id,threads[i].join);
    4371:	50                   	push   %eax
    4372:	ff 73 f8             	pushl  -0x8(%ebx)
    4375:	83 c3 24             	add    $0x24,%ebx
    4378:	68 f0 62 00 00       	push   $0x62f0
    437d:	6a 01                	push   $0x1
    437f:	e8 8c f6 ff ff       	call   3a10 <printf>
      threads[i].join = -1;
    4384:	c7 43 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebx)
      threads[i].state = RUNNABLE_THREAD;
    438b:	c7 43 dc 02 00 00 00 	movl   $0x2,-0x24(%ebx)
    4392:	83 c4 10             	add    $0x10,%esp
{
  alarm(0); // disabling alarm - don't want interrupts
  printf(1, "------ scheduleing ------\n");
  int sleeping=0;
  /* check if there any process to wake up*/
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    4395:	81 fb a8 c2 00 00    	cmp    $0xc2a8,%ebx
    439b:	75 ae                	jne    434b <uthread_schedule+0x3b>
  ...
  int prev_index = index_currently_running;
    43a0:	8b 1d c4 48 01 00    	mov    0x148c4,%ebx
  int check=1;
  for (int i=prev_index+1;check<=MAX_UTHREADS;i++) {
    43a6:	ba 40 00 00 00       	mov    $0x40,%edx
void
uthread_schedule()
{
  alarm(0); // disabling alarm - don't want interrupts
  printf(1, "------ scheduleing ------\n");
  int sleeping=0;
    43ab:	31 c9                	xor    %ecx,%ecx
	 // printf(1,"i: %d\n",i);
      index_currently_running = i;
      break;
    }
    if (threads[i].state ==SLEEPING_THREAD)
    sleeping=1;
    43ad:	be 01 00 00 00       	mov    $0x1,%esi
  }
  ...
  int check=1;
  for (int i=prev_index+1;check<=MAX_UTHREADS;i++) {
    43b2:	8d 43 01             	lea    0x1(%ebx),%eax
    43b5:	eb 1b                	jmp    43d2 <uthread_schedule+0xc2>
    ...
    if (threads[i].state ==SLEEPING_THREAD)
    sleeping=1;
    43c0:	83 ff 01             	cmp    $0x1,%edi
    43c3:	0f 44 ce             	cmove  %esi,%ecx
  }
  ...
  int check=1;
  for (int i=prev_index+1;check<=MAX_UTHREADS;i++) {
    43c6:	83 c0 01             	add    $0x1,%eax
    43c9:	83 ea 01             	sub    $0x1,%edx
    43cc:	0f 84 8a 00 00 00    	je     445c <uthread_schedule+0x14c>
    i=i%MAX_UTHREADS;
    43d2:	89 c7                	mov    %eax,%edi
    43d4:	c1 ff 1f             	sar    $0x1f,%edi
    43d7:	c1 ef 1a             	shr    $0x1a,%edi
    43da:	01 f8                	add    %edi,%eax
    43dc:	83 e0 3f             	and    $0x3f,%eax
    43df:	29 f8                	sub    %edi,%eax
    if(threads[i].state == RUNNABLE_THREAD && i!=prev_index){
    43e1:	8d 3c c0             	lea    (%eax,%eax,8),%edi
    43e4:	8b 3c bd a8 b9 00 00 	mov    0xb9a8(,%edi,4),%edi
    43eb:	83 ff 02             	cmp    $0x2,%edi
    43ee:	75 d0                	jne    43c0 <uthread_schedule+0xb0>
    43f0:	39 c3                	cmp    %eax,%ebx
    43f2:	74 d2                	je     43c6 <uthread_schedule+0xb6>
	 // printf(1,"i: %d\n",i);
      index_currently_running = i;
    43f4:	a3 c4 48 01 00       	mov    %eax,0x148c4
    43f9:	e9 91 00 00 00       	jmp    448f <uthread_schedule+0x17f>
  ...
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    if(threads[i].state == SLEEPING_THREAD && threads[i].time_to_get_up!=0 && threads[i].time_to_get_up <= uptime()){
    4400:	e8 35 f5 ff ff       	call   393a <uptime>
    4405:	39 c6                	cmp    %eax,%esi
    4407:	7e 17                	jle    4420 <uthread_schedule+0x110>
      printf(1,"tread %d was sleeping now he woke up!!\n",threads[i].thread_id);
      printf(1,"current tick is %d\n",uptime());
      threads[i].state = RUNNABLE_THREAD;
      threads[i].time_to_get_up = 0;
    ...
    if(threads[i].state == SLEEPING_THREAD && threads[i].join!= -1 && threads[threads[i].join].state == UNUSED_THREAD) {
    4409:	83 3b 01             	cmpl   $0x1,(%ebx)
    440c:	0f 84 49 ff ff ff    	je     435b <uthread_schedule+0x4b>
    4412:	e9 29 ff ff ff       	jmp    4340 <uthread_schedule+0x30>
    4417:	89 f6                	mov    %esi,%esi
    4419:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  printf(1, "------ scheduleing ------\n");
  int sleeping=0;
  /* check if there any process to wake up*/
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    ...
    4423:	ff 73 f8             	pushl  -0x8(%ebx)
    4426:	68 c8 62 00 00       	push   $0x62c8
    442b:	6a 01                	push   $0x1
    442d:	e8 de f5 ff ff       	call   3a10 <printf>
      printf(1,"current tick is %d\n",uptime());
    4432:	e8 03 f5 ff ff       	call   393a <uptime>
    4437:	83 c4 0c             	add    $0xc,%esp
    443a:	50                   	push   %eax
    443b:	68 61 65 00 00       	push   $0x6561
    4440:	6a 01                	push   $0x1
    4442:	e8 c9 f5 ff ff       	call   3a10 <printf>
      threads[i].state = RUNNABLE_THREAD;
    4447:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
      threads[i].time_to_get_up = 0;
    444d:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    4454:	83 c4 10             	add    $0x10,%esp
    4457:	e9 e4 fe ff ff       	jmp    4340 <uthread_schedule+0x30>
    if (threads[i].state ==SLEEPING_THREAD)
    sleeping=1;
    check++;
  }
  if(prev_index == index_currently_running){
    if (threads[prev_index].state == RUNNING_THREAD || threads[prev_index].state == RUNNABLE_THREAD ){
    445c:	8d 04 db             	lea    (%ebx,%ebx,8),%eax
    445f:	8b 04 85 a8 b9 00 00 	mov    0xb9a8(,%eax,4),%eax
    4466:	83 e8 02             	sub    $0x2,%eax
    4469:	83 f8 01             	cmp    $0x1,%eax
    446c:	76 3f                	jbe    44ad <uthread_schedule+0x19d>
      printf(1,"thread %d is already running!\nswitching to myself\n",index_currently_running);
    }
    else{
      if (sleeping == 1){
    446e:	83 f9 01             	cmp    $0x1,%ecx
    4471:	75 54                	jne    44c7 <uthread_schedule+0x1b7>
        printf(1,"there is a sleeping thread... zZzzZzzzZzzz...\n");
    4473:	83 ec 08             	sub    $0x8,%esp
    4476:	68 54 63 00 00       	push   $0x6354
    447b:	6a 01                	push   $0x1
    447d:	e8 8e f5 ff ff       	call   3a10 <printf>
        // sleep(25);
        uthread_schedule();
    4482:	e8 89 fe ff ff       	call   4310 <uthread_schedule>
    4487:	a1 c4 48 01 00       	mov    0x148c4,%eax
    448c:	83 c4 10             	add    $0x10,%esp
      }
    }
  }
  ...
  contexSwitch(prev_index,index_currently_running);
    448f:	83 ec 08             	sub    $0x8,%esp
    4492:	50                   	push   %eax
    4493:	53                   	push   %ebx
    4494:	e8 d7 fd ff ff       	call   4270 <contexSwitch>
  alarm(UTHREAD_QUANTA);
    4499:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    44a0:	e8 b5 f4 ff ff       	call   395a <alarm>
}
    44a5:	8d 65 f4             	lea    -0xc(%ebp),%esp
    44a8:	5b                   	pop    %ebx
    44a9:	5e                   	pop    %esi
    44aa:	5f                   	pop    %edi
    44ab:	5d                   	pop    %ebp
  ...
  if(prev_index == index_currently_running){
    if (threads[prev_index].state == RUNNING_THREAD || threads[prev_index].state == RUNNABLE_THREAD ){
      printf(1,"thread %d is already running!\nswitching to myself\n",index_currently_running);
    44ad:	83 ec 04             	sub    $0x4,%esp
    44b0:	53                   	push   %ebx
    44b1:	68 20 63 00 00       	push   $0x6320
    44b6:	6a 01                	push   $0x1
    44b8:	e8 53 f5 ff ff       	call   3a10 <printf>
    44bd:	a1 c4 48 01 00       	mov    0x148c4,%eax
    44c2:	83 c4 10             	add    $0x10,%esp
    44c5:	eb c8                	jmp    448f <uthread_schedule+0x17f>
        printf(1,"there is a sleeping thread... zZzzZzzzZzzz...\n");
        // sleep(25);
        uthread_schedule();
      }
      else{
        printf(1,"no threads to run! exit!!!\n");
    44c7:	83 ec 08             	sub    $0x8,%esp
    44ca:	68 75 65 00 00       	push   $0x6575
    44cf:	6a 01                	push   $0x1
    44d1:	e8 3a f5 ff ff       	call   3a10 <printf>
        exit();
    44d6:	e8 c7 f3 ff ff       	call   38a2 <exit>
    44db:	90                   	nop
    44dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
void bsem_down(int id) {
    ...
    44eb:	8b 75 08             	mov    0x8(%ebp),%esi
  alarm(0);
    44ee:	6a 00                	push   $0x0
    44f0:	e8 65 f4 ff ff       	call   395a <alarm>
    44f5:	b8 c4 c2 00 00       	mov    $0xc2c4,%eax
    44fa:	83 c4 10             	add    $0x10,%esp
    44fd:	eb 15                	jmp    4514 <bsem_down+0x34>
    44ff:	90                   	nop
  int i;
  /* searching for Semaphore */
  for(i = 0; i <MAX_BSEM; i++) {
    4500:	83 c3 01             	add    $0x1,%ebx
    4503:	05 0c 01 00 00       	add    $0x10c,%eax
    4508:	81 fb 80 00 00 00    	cmp    $0x80,%ebx
    450e:	0f 84 bc 00 00 00    	je     45d0 <bsem_down+0xf0>
    if(binSemaphore[i].id == id && binSemaphore[i].state == USED)
    4514:	39 30                	cmp    %esi,(%eax)
    4516:	75 e8                	jne    4500 <bsem_down+0x20>
    4518:	8b 90 04 01 00 00    	mov    0x104(%eax),%edx
    451e:	85 d2                	test   %edx,%edx
    4520:	75 de                	jne    4500 <bsem_down+0x20>
    break;
  }
  /* found */
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 1) { //if lock not taken
    4522:	69 fb 0c 01 00 00    	imul   $0x10c,%ebx,%edi
    4528:	83 bf c0 c2 00 00 01 	cmpl   $0x1,0xc2c0(%edi)
    452f:	0f 84 b0 00 00 00    	je     45e5 <bsem_down+0x105>
    ...
    4535:	a1 c4 48 01 00       	mov    0x148c4,%eax
    453a:	56                   	push   %esi
    453b:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    453e:	ff 34 85 a0 b9 00 00 	pushl  0xb9a0(,%eax,4)
    4545:	68 bc 63 00 00       	push   $0x63bc
    454a:	6a 01                	push   $0x1
    454c:	e8 bf f4 ff ff       	call   3a10 <printf>
    4551:	83 c4 10             	add    $0x10,%esp
	for (int j=0;j<MAX_UTHREADS;j++){
    4554:	31 c0                	xor    %eax,%eax
    4556:	eb 10                	jmp    4568 <bsem_down+0x88>
    4558:	90                   	nop
    4559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    4560:	83 c0 01             	add    $0x1,%eax
    4563:	83 f8 40             	cmp    $0x40,%eax
    4566:	74 26                	je     458e <bsem_down+0xae>
      if (binSemaphore[i].sleep[j] == -1){
    4568:	83 bc 87 c8 c2 00 00 	cmpl   $0xffffffff,0xc2c8(%edi,%eax,4)
    456f:	ff 
    4570:	75 ee                	jne    4560 <bsem_down+0x80>
      binSemaphore[i].sleep[j] = threads[index_currently_running].thread_id;
    4572:	8b 15 c4 48 01 00    	mov    0x148c4,%edx
    4578:	6b db 43             	imul   $0x43,%ebx,%ebx
    457b:	8d 14 d2             	lea    (%edx,%edx,8),%edx
    457e:	01 d8                	add    %ebx,%eax
    4580:	8b 14 95 a0 b9 00 00 	mov    0xb9a0(,%edx,4),%edx
    4587:	89 14 85 c8 c2 00 00 	mov    %edx,0xc2c8(,%eax,4)
	  break;
	  }
    }
    printf(1,"zZzzZzzzZzzz.....\n");
    458e:	83 ec 08             	sub    $0x8,%esp
    4591:	68 91 65 00 00       	push   $0x6591
    4596:	6a 01                	push   $0x1
    4598:	e8 73 f4 ff ff       	call   3a10 <printf>
	 threads[index_currently_running].state = BLOCKED_THREAD;
    459d:	a1 c4 48 01 00       	mov    0x148c4,%eax
    45a2:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    45a5:	c7 04 85 a8 b9 00 00 	movl   $0x4,0xb9a8(,%eax,4)
    45ac:	04 00 00 00 

	 uthread_schedule();
    45b0:	e8 5b fd ff ff       	call   4310 <uthread_schedule>
...
printf(1,"you tried to lock a binary semaphore that does not exist! (id: %d)\n", id);
alarm(UTHREAD_QUANTA);
    45b8:	c7 45 08 05 00 00 00 	movl   $0x5,0x8(%ebp)
}
    45bf:	8d 65 f4             	lea    -0xc(%ebp),%esp
    45c2:	5b                   	pop    %ebx
    45c3:	5e                   	pop    %esi
    45c4:	5f                   	pop    %edi
    45c5:	5d                   	pop    %ebp
...
printf(1,"you tried to lock a binary semaphore that does not exist! (id: %d)\n", id);
alarm(UTHREAD_QUANTA);
    45c6:	e9 8f f3 ff ff       	jmp    395a <alarm>
    45cb:	90                   	nop
...
printf(1,"you tried to lock a binary semaphore that does not exist! (id: %d)\n", id);
    45d0:	83 ec 04             	sub    $0x4,%esp
    45d3:	56                   	push   %esi
    45d4:	68 10 64 00 00       	push   $0x6410
    45d9:	6a 01                	push   $0x1
    45db:	e8 30 f4 ff ff       	call   3a10 <printf>
    45e0:	83 c4 10             	add    $0x10,%esp
    45e3:	eb d3                	jmp    45b8 <bsem_down+0xd8>
    break;
  }
  /* found */
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 1) { //if lock not taken
      printf(1, "thread %d got lock for binary semaphore with id %d \n",threads[index_currently_running].thread_id, id);
    45e5:	a1 c4 48 01 00       	mov    0x148c4,%eax
    45ea:	56                   	push   %esi
    45eb:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    45ee:	ff 34 85 a0 b9 00 00 	pushl  0xb9a0(,%eax,4)
    45f5:	68 84 63 00 00       	push   $0x6384
    45fa:	6a 01                	push   $0x1
    45fc:	e8 0f f4 ff ff       	call   3a10 <printf>
      binSemaphore[i].lock=0;
    4601:	c7 87 c0 c2 00 00 00 	movl   $0x0,0xc2c0(%edi)
    4608:	00 00 00 
    460b:	83 c4 10             	add    $0x10,%esp
    460e:	eb a8                	jmp    45b8 <bsem_down+0xd8>

00004610 <uthread_exit>:
  return;
}
...
uthread_exit()
{
    ...
    4613:	53                   	push   %ebx
    4614:	83 ec 10             	sub    $0x10,%esp
  alarm(0); // stopping the alarm until we finish exiting
    4617:	6a 00                	push   $0x0
    4619:	e8 3c f3 ff ff       	call   395a <alarm>
  printf(1,"exiting...\n");
    461e:	5a                   	pop    %edx
    461f:	59                   	pop    %ecx
    4620:	68 a4 65 00 00       	push   $0x65a4
    4625:	6a 01                	push   $0x1
    4627:	e8 e4 f3 ff ff       	call   3a10 <printf>
  /* check if i am the main thread*/
  if(threads[index_currently_running].thread_id == 0)
    462c:	a1 c4 48 01 00       	mov    0x148c4,%eax
    4631:	83 c4 10             	add    $0x10,%esp
    4634:	8d 14 c0             	lea    (%eax,%eax,8),%edx
    4637:	8b 1c 95 a0 b9 00 00 	mov    0xb9a0(,%edx,4),%ebx
    463e:	85 db                	test   %ebx,%ebx
    4640:	75 0a                	jne    464c <uthread_exit+0x3c>
  {
    threads[0].state = UNUSED_THREAD;
    4642:	c7 05 a8 b9 00 00 00 	movl   $0x0,0xb9a8
    4649:	00 00 00 
  }
  /* need to clean the thread field*/

  free(threads[index_currently_running].stack);
    464c:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    464f:	83 ec 0c             	sub    $0xc,%esp
    4652:	bb a8 b9 00 00       	mov    $0xb9a8,%ebx
    4657:	ff 34 85 a4 b9 00 00 	pushl  0xb9a4(,%eax,4)
    465e:	e8 4d f5 ff ff       	call   3bb0 <free>
  threads[index_currently_running].state = UNUSED_THREAD;
    4663:	a1 c4 48 01 00       	mov    0x148c4,%eax
    4668:	83 c4 10             	add    $0x10,%esp
    466b:	8d 14 c0             	lea    (%eax,%eax,8),%edx
    466e:	c1 e2 02             	shl    $0x2,%edx
    4671:	c7 82 a8 b9 00 00 00 	movl   $0x0,0xb9a8(%edx)
    4678:	00 00 00 
  threads[index_currently_running].thread_id = -1;
    467b:	c7 82 a0 b9 00 00 ff 	movl   $0xffffffff,0xb9a0(%edx)
    4682:	ff ff ff 
  threads[index_currently_running].ebp = 0;
    4685:	c7 82 ac b9 00 00 00 	movl   $0x0,0xb9ac(%edx)
    468c:	00 00 00 
  threads[index_currently_running].esp = 0;
    468f:	c7 82 b0 b9 00 00 00 	movl   $0x0,0xb9b0(%edx)
    4696:	00 00 00 
  threads[index_currently_running].time_to_get_up = 0;
    4699:	c7 82 bc b9 00 00 00 	movl   $0x0,0xb9bc(%edx)
    46a0:	00 00 00 
  threads[index_currently_running].join = -1;
    46a3:	c7 82 c0 b9 00 00 ff 	movl   $0xffffffff,0xb9c0(%edx)
    46aa:	ff ff ff 
    46ad:	eb 0c                	jmp    46bb <uthread_exit+0xab>
    46af:	90                   	nop
    46b0:	83 c3 24             	add    $0x24,%ebx
  /* need to find another process to run */
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    46b3:	81 fb a8 c2 00 00    	cmp    $0xc2a8,%ebx
    46b9:	74 16                	je     46d1 <uthread_exit+0xc1>
    if(threads[i].state != UNUSED_THREAD) // there is more thread to run
    46bb:	8b 03                	mov    (%ebx),%eax
    46bd:	85 c0                	test   %eax,%eax
    46bf:	74 ef                	je     46b0 <uthread_exit+0xa0>
    46c1:	83 c3 24             	add    $0x24,%ebx
    uthread_schedule();
    46c4:	e8 47 fc ff ff       	call   4310 <uthread_schedule>
  threads[index_currently_running].ebp = 0;
  threads[index_currently_running].esp = 0;
  threads[index_currently_running].time_to_get_up = 0;
  threads[index_currently_running].join = -1;
  /* need to find another process to run */
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    46c9:	81 fb a8 c2 00 00    	cmp    $0xc2a8,%ebx
    46cf:	75 ea                	jne    46bb <uthread_exit+0xab>
    if(threads[i].state != UNUSED_THREAD) // there is more thread to run
    uthread_schedule();
  }
  exit();
    46d1:	e8 cc f1 ff ff       	call   38a2 <exit>
    46d6:	8d 76 00             	lea    0x0(%esi),%esi
    46d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000046e0 <uthred_self>:
}
...
uthred_self()
{
  return threads[index_currently_running].thread_id;
    46e0:	a1 c4 48 01 00       	mov    0x148c4,%eax
...
uthred_self()
{
  ...
  return threads[index_currently_running].thread_id;
    46e8:	8d 04 c0             	lea    (%eax,%eax,8),%eax
}
    46eb:	5d                   	pop    %ebp
}
...
uthred_join(int tid)
{
    ...
    4703:	56                   	push   %esi
    4704:	53                   	push   %ebx
    4705:	8b 75 08             	mov    0x8(%ebp),%esi
  if(tid > id_number_thread || tid < 0){ // checking if the tid is relevent
    4708:	39 35 c0 48 01 00    	cmp    %esi,0x148c0
    470e:	0f 8c a3 00 00 00    	jl     47b7 <uthred_join+0xb7>
    4714:	89 f0                	mov    %esi,%eax
    4716:	c1 e8 1f             	shr    $0x1f,%eax
    4719:	84 c0                	test   %al,%al
    471b:	0f 85 96 00 00 00    	jne    47b7 <uthred_join+0xb7>
    return -1;
  }
  alarm(0);
    4721:	83 ec 0c             	sub    $0xc,%esp
  /* first we are looking for the process*/
  int found_tid = -1;
  for(int i = 0 ; i < MAX_UTHREADS ; i++) {
    4724:	31 db                	xor    %ebx,%ebx
uthred_join(int tid)
{
  if(tid > id_number_thread || tid < 0){ // checking if the tid is relevent
    return -1;
  ...
  alarm(0);
    4726:	6a 00                	push   $0x0
    4728:	e8 2d f2 ff ff       	call   395a <alarm>
    472d:	b8 a0 b9 00 00       	mov    $0xb9a0,%eax
    4732:	83 c4 10             	add    $0x10,%esp
    4735:	eb 14                	jmp    474b <uthred_join+0x4b>
    4737:	89 f6                	mov    %esi,%esi
    4739:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  /* first we are looking for the process*/
  int found_tid = -1;
  for(int i = 0 ; i < MAX_UTHREADS ; i++) {
    4740:	83 c3 01             	add    $0x1,%ebx
    4743:	83 c0 24             	add    $0x24,%eax
    4746:	83 fb 40             	cmp    $0x40,%ebx
    4749:	74 4d                	je     4798 <uthred_join+0x98>
    if(threads[i].thread_id == tid && threads[i].state!=UNUSED_THREAD){
    474b:	3b 30                	cmp    (%eax),%esi
    474d:	75 f1                	jne    4740 <uthred_join+0x40>
    474f:	8b 50 08             	mov    0x8(%eax),%edx
    4752:	85 d2                	test   %edx,%edx
    4754:	74 ea                	je     4740 <uthred_join+0x40>
    alarm(UTHREAD_QUANTA);
    return -1;
  }
  /* there is a process with this tid*/
    ...
    4756:	53                   	push   %ebx
    4757:	ff 35 c4 48 01 00    	pushl  0x148c4
    475d:	68 b0 65 00 00       	push   $0x65b0
    4762:	6a 01                	push   $0x1
    4764:	e8 a7 f2 ff ff       	call   3a10 <printf>
    threads[index_currently_running].join=found_tid;
    4769:	a1 c4 48 01 00       	mov    0x148c4,%eax
    476e:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    4771:	8d 04 85 a0 b9 00 00 	lea    0xb9a0(,%eax,4),%eax
    4778:	89 58 20             	mov    %ebx,0x20(%eax)
    threads[index_currently_running].state=SLEEPING_THREAD;
    477b:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%eax)
    uthread_schedule();
    4782:	e8 89 fb ff ff       	call   4310 <uthread_schedule>
  }
  return 0;
    4787:	83 c4 10             	add    $0x10,%esp

}
    478a:	8d 65 f8             	lea    -0x8(%ebp),%esp
    printf(1,"thread %d waiting for %d\n",index_currently_running,found_tid);
    threads[index_currently_running].join=found_tid;
    threads[index_currently_running].state=SLEEPING_THREAD;
    uthread_schedule();
  ...
  return 0;
    ...
    4792:	c3                   	ret    
    4793:	90                   	nop
    4794:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      break;
    }
  }
  /* there is no process with this tid so we are returning*/
  if(found_tid == -1) {
    printf(1, "there is no tid %d. returning\n", tid);
    4798:	83 ec 04             	sub    $0x4,%esp
    479b:	56                   	push   %esi
    479c:	68 54 64 00 00       	push   $0x6454
    47a1:	6a 01                	push   $0x1
    47a3:	e8 68 f2 ff ff       	call   3a10 <printf>
    alarm(UTHREAD_QUANTA);
    47a8:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    47af:	e8 a6 f1 ff ff       	call   395a <alarm>
    return -1;
  ...
  if(found_tid == -1) {
    ...
    alarm(UTHREAD_QUANTA);
    return -1;
    47ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    threads[index_currently_running].state=SLEEPING_THREAD;
    uthread_schedule();
  }
  return 0;
    ...
    47c1:	5d                   	pop    %ebp
    47c2:	c3                   	ret    
    47c3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    47c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000047d0 <uthred_sleep>:
...
uthred_sleep(int ticks)
{
    ...
    47d3:	56                   	push   %esi
    47d4:	53                   	push   %ebx
    47d5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  alarm(0);
    47d8:	83 ec 0c             	sub    $0xc,%esp
    47db:	6a 00                	push   $0x0
    47dd:	e8 78 f1 ff ff       	call   395a <alarm>
  threads[index_currently_running].time_to_get_up = uptime()+ticks;
    47e2:	8b 35 c4 48 01 00    	mov    0x148c4,%esi
    47e8:	e8 4d f1 ff ff       	call   393a <uptime>
    47ed:	01 d8                	add    %ebx,%eax
    47ef:	8d 14 f6             	lea    (%esi,%esi,8),%edx
    47f2:	89 04 95 bc b9 00 00 	mov    %eax,0xb9bc(,%edx,4)
  threads[index_currently_running].state = SLEEPING_THREAD;
    47f9:	a1 c4 48 01 00       	mov    0x148c4,%eax
    47fe:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    4801:	8d 04 85 a0 b9 00 00 	lea    0xb9a0(,%eax,4),%eax
  printf(1, "thread %d went to sleep for %d ticks, current time is %d  , i will sleep untill tick %d zZzzZzzzZzzz.... \n", index_currently_running,ticks,uptime(),threads[index_currently_running].time_to_get_up);
    4808:	8b 70 1c             	mov    0x1c(%eax),%esi
int
uthred_sleep(int ticks)
{
  alarm(0);
  threads[index_currently_running].time_to_get_up = uptime()+ticks;
  threads[index_currently_running].state = SLEEPING_THREAD;
    480b:	c7 40 08 01 00 00 00 	movl   $0x1,0x8(%eax)
  printf(1, "thread %d went to sleep for %d ticks, current time is %d  , i will sleep untill tick %d zZzzZzzzZzzz.... \n", index_currently_running,ticks,uptime(),threads[index_currently_running].time_to_get_up);
    4812:	e8 23 f1 ff ff       	call   393a <uptime>
    4817:	5a                   	pop    %edx
    4818:	59                   	pop    %ecx
    4819:	56                   	push   %esi
    481a:	50                   	push   %eax
    481b:	53                   	push   %ebx
    481c:	ff 35 c4 48 01 00    	pushl  0x148c4
    4822:	68 74 64 00 00       	push   $0x6474
    4827:	6a 01                	push   $0x1
    4829:	e8 e2 f1 ff ff       	call   3a10 <printf>
  uthread_schedule();
    482e:	83 c4 20             	add    $0x20,%esp
    4831:	e8 da fa ff ff       	call   4310 <uthread_schedule>
  return 0;
}
    4836:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
{
    4840:	55                   	push   %ebp
    4841:	89 e5                	mov    %esp,%ebp
    4843:	53                   	push   %ebx
    4844:	83 ec 04             	sub    $0x4,%esp
    4847:	8b 5d 08             	mov    0x8(%ebp),%ebx
  csem->value = value;
    484a:	8b 45 0c             	mov    0xc(%ebp),%eax
    484d:	89 43 08             	mov    %eax,0x8(%ebx)
  csem->bsem_1_id = bsem_alloc();
    4850:	e8 6b f5 ff ff       	call   3dc0 <bsem_alloc>
    4855:	89 03                	mov    %eax,(%ebx)
  csem->bsem_2_id = bsem_alloc();
    4857:	e8 64 f5 ff ff       	call   3dc0 <bsem_alloc>
    485c:	89 43 04             	mov    %eax,0x4(%ebx)
}
    485f:	83 c4 04             	add    $0x4,%esp
    4862:	5b                   	pop    %ebx
    4863:	5d                   	pop    %ebp
    4864:	c3                   	ret    
    4865:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    4869:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
...
void csem_free(struct counting_semaphore *csem)
{
    ...
    4873:	53                   	push   %ebx
    4874:	83 ec 10             	sub    $0x10,%esp
    4877:	8b 5d 08             	mov    0x8(%ebp),%ebx
  /* cleaning */
  csem->value = 0;
    487a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  bsem_free(csem->bsem_1_id);
    4881:	ff 33                	pushl  (%ebx)
    4883:	e8 38 f6 ff ff       	call   3ec0 <bsem_free>
  bsem_free(csem->bsem_2_id);
    4888:	8b 43 04             	mov    0x4(%ebx),%eax
    488b:	83 c4 10             	add    $0x10,%esp
}
    488e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
void csem_free(struct counting_semaphore *csem)
{
  /* cleaning */
  csem->value = 0;
...
void csem_free(struct counting_semaphore *csem)
{
  ...
  bsem_free(csem->bsem_1_id);
  bsem_free(csem->bsem_2_id);
    4895:	e9 26 f6 ff ff       	jmp    3ec0 <bsem_free>
...
void csem_down(struct counting_semaphore *csem)
{
    ...
    48a3:	53                   	push   %ebx
    48a4:	83 ec 10             	sub    $0x10,%esp
    48a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bsem_down(csem->bsem_2_id); // down for semaphore number 2
    48aa:	ff 73 04             	pushl  0x4(%ebx)
    48ad:	e8 2e fc ff ff       	call   44e0 <bsem_down>
  bsem_down(csem->bsem_1_id); // down for semaphore number 1
    48b2:	58                   	pop    %eax
    48b3:	ff 33                	pushl  (%ebx)
    48b5:	e8 26 fc ff ff       	call   44e0 <bsem_down>
  csem->value--;
    48ba:	8b 43 08             	mov    0x8(%ebx),%eax
  if(csem->value > 0) // can add more thread
    48bd:	83 c4 10             	add    $0x10,%esp
...
void csem_down(struct counting_semaphore *csem)
{
  ...
  bsem_down(csem->bsem_1_id); // down for semaphore number 1
  csem->value--;
    48c5:	89 43 08             	mov    %eax,0x8(%ebx)
  if(csem->value > 0) // can add more thread
    48c8:	7e 0e                	jle    48d8 <csem_down+0x38>
  {
    bsem_up(csem->bsem_2_id);
    48ca:	83 ec 0c             	sub    $0xc,%esp
    48cd:	ff 73 04             	pushl  0x4(%ebx)
    48d0:	e8 ab f6 ff ff       	call   3f80 <bsem_up>
    48d5:	83 c4 10             	add    $0x10,%esp
  }
  bsem_up(csem->bsem_1_id);
    48d8:	8b 03                	mov    (%ebx),%eax
}
    48da:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  csem->value--;
  if(csem->value > 0) // can add more thread
  {
    bsem_up(csem->bsem_2_id);
  ...
  bsem_up(csem->bsem_1_id);
    48e1:	e9 9a f6 ff ff       	jmp    3f80 <bsem_up>
    48e6:	8d 76 00             	lea    0x0(%esi),%esi
    48e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
...
void csem_up(struct counting_semaphore *csem)
{
    ...
    48f3:	53                   	push   %ebx
    48f4:	83 ec 10             	sub    $0x10,%esp
    48f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bsem_down(csem->bsem_1_id);
    48fa:	ff 33                	pushl  (%ebx)
    48fc:	e8 df fb ff ff       	call   44e0 <bsem_down>
  csem->value++;
    4901:	8b 43 08             	mov    0x8(%ebx),%eax
  if(csem->value == 1)
    4904:	83 c4 10             	add    $0x10,%esp
}
...
void csem_up(struct counting_semaphore *csem)
{
  bsem_down(csem->bsem_1_id);
  csem->value++;
    4907:	83 c0 01             	add    $0x1,%eax
  if(csem->value == 1)
    490a:	83 f8 01             	cmp    $0x1,%eax
}
...
void csem_up(struct counting_semaphore *csem)
{
  bsem_down(csem->bsem_1_id);
  csem->value++;
    490d:	89 43 08             	mov    %eax,0x8(%ebx)
  if(csem->value == 1)
    4910:	74 0e                	je     4920 <csem_up+0x30>
  {
    bsem_up(csem->bsem_2_id);
  }
  bsem_up(csem->bsem_1_id);
    4912:	8b 03                	mov    (%ebx),%eax
}
    4914:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  csem->value++;
  if(csem->value == 1)
  {
    bsem_up(csem->bsem_2_id);
  ...
  bsem_up(csem->bsem_1_id);
    491b:	e9 60 f6 ff ff       	jmp    3f80 <bsem_up>
{
  bsem_down(csem->bsem_1_id);
  csem->value++;
  if(csem->value == 1)
  {
    bsem_up(csem->bsem_2_id);
    4920:	83 ec 0c             	sub    $0xc,%esp
    4923:	ff 73 04             	pushl  0x4(%ebx)
    4926:	e8 55 f6 ff ff       	call   3f80 <bsem_up>
  }
  bsem_up(csem->bsem_1_id);
    492b:	8b 03                	mov    (%ebx),%eax
{
  bsem_down(csem->bsem_1_id);
  csem->value++;
  if(csem->value == 1)
  {
    bsem_up(csem->bsem_2_id);
    492d:	83 c4 10             	add    $0x10,%esp
  }
  bsem_up(csem->bsem_1_id);
}
    4930:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  csem->value++;
  if(csem->value == 1)
  {
    bsem_up(csem->bsem_2_id);
  ...
  bsem_up(csem->bsem_1_id);
    4937:	e9 44 f6 ff ff       	jmp    3f80 <bsem_up>
