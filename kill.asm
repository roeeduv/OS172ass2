...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     3af:	f7 f6                	div    %esi
     3b1:	0f b6 92 18 12 00 00 	movzbl 0x1218(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
     52b:	b8 10 12 00 00       	mov    $0x1210,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     5b1:	a1 80 19 00 00       	mov    0x1980,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
     609:	a3 80 19 00 00       	mov    %eax,0x1980
}
     60e:	5b                   	pop    %ebx
     60f:	5e                   	pop    %esi
     610:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
     62d:	a3 80 19 00 00       	mov    %eax,0x1980
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     64c:	8b 15 80 19 00 00    	mov    0x1980,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
     6a1:	39 05 80 19 00 00    	cmp    %eax,0x1980
  ...
  return freep;
     6cb:	8b 15 80 19 00 00    	mov    0x1980,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
     ...
     6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
     6ef:	89 15 80 19 00 00    	mov    %edx,0x1980
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
     706:	c7 05 80 19 00 00 84 	movl   $0x1984,0x1980
     70d:	19 00 00 
     710:	c7 05 84 19 00 00 84 	movl   $0x1984,0x1984
     717:	19 00 00 
    base.s.size = 0;
     71a:	b8 84 19 00 00       	mov    $0x1984,%eax
     71f:	c7 05 88 19 00 00 00 	movl   $0x0,0x1988
     726:	00 00 00 
...
run_thread(void (*start_func)(void *), void*arg)
{
  ...
  printf(1, "---- running the function ----\n");
     ...
     73e:	68 2c 12 00 00       	push   $0x122c
     743:	6a 01                	push   $0x1
...
uthread_exit()
{
  ...
  free(threads[index_currently_running].stack);
     ...
     7b2:	ff 34 85 a4 19 00 00 	pushl  0x19a4(,%eax,4)
     7b9:	e8 f2 fd ff ff       	call   5b0 <free>
  threads[index_currently_running].state = UNUSED_THREAD;
     7be:	a1 c8 a8 00 00       	mov    0xa8c8,%eax
     7c3:	83 c4 10             	add    $0x10,%esp
     7c6:	8d 14 c0             	lea    (%eax,%eax,8),%edx
     7c9:	b8 a8 19 00 00       	mov    $0x19a8,%eax
     7ce:	c1 e2 02             	shl    $0x2,%edx
     7d1:	c7 82 a8 19 00 00 00 	movl   $0x0,0x19a8(%edx)
     7d8:	00 00 00 
  threads[index_currently_running].thread_id = -1;
     7db:	c7 82 a0 19 00 00 ff 	movl   $0xffffffff,0x19a0(%edx)
     7e2:	ff ff ff 
  threads[index_currently_running].ebp = 0;
     7e5:	c7 82 ac 19 00 00 00 	movl   $0x0,0x19ac(%edx)
     7ec:	00 00 00 
  threads[index_currently_running].esp = 0;
     7ef:	c7 82 b0 19 00 00 00 	movl   $0x0,0x19b0(%edx)
     7f6:	00 00 00 
  threads[index_currently_running].time_to_get_up = 0;
     7f9:	c7 82 bc 19 00 00 00 	movl   $0x0,0x19bc(%edx)
     800:	00 00 00 
  threads[index_currently_running].join = -1;
     803:	c7 82 c0 19 00 00 ff 	movl   $0xffffffff,0x19c0(%edx)
     80a:	ff ff ff 
  ...
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
     813:	3d a8 22 00 00       	cmp    $0x22a8,%eax
  ...
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
     828:	3d a8 22 00 00       	cmp    $0x22a8,%eax
     82d:	75 eb                	jne    81a <uthread_exit+0xaa>
     82f:	bb cc 19 00 00       	mov    $0x19cc,%ebx
  ...
  for(int i = 1 ; i < MAX_UTHREADS ; i++){
     843:	81 fb a8 22 00 00    	cmp    $0x22a8,%ebx
  ...
  for(int i = 1 ; i < MAX_UTHREADS ; i++){
     867:	81 fb a8 22 00 00    	cmp    $0x22a8,%ebx
...
{
     880:	55                   	push   %ebp
     881:	ba c8 23 00 00       	mov    $0x23c8,%edx
...
{
  for(int i = 0; i <MAX_BSEM; i++) {
     8b3:	81 fa c8 a9 00 00    	cmp    $0xa9c8,%edx
  ...
  first_run_bsem=1;
     8bb:	c7 05 8c 19 00 00 01 	movl   $0x1,0x198c
     8c2:	00 00 00 
}
     8c5:	5d                   	pop    %ebp
     8c6:	c3                   	ret    
...
{
  for(int i = 0; i <MAX_BSEM; i++) {
     913:	81 fa c8 a9 00 00    	cmp    $0xa9c8,%edx
  ...
  //printf(1,"done init binary semaphore!\n");
  first_run_bsem=1;
     91b:	c7 05 8c 19 00 00 01 	movl   $0x1,0x198c
     922:	00 00 00 
     925:	ba c8 23 00 00       	mov    $0x23c8,%edx
  if(first_run_bsem == 0)
  {
    init_bsem();
  }
  ...
  if (i<MAX_BSEM){
    binSemaphore[i].id = binSemCounter;
     ...
     949:	8b 15 7c 19 00 00    	mov    0x197c,%edx
    binSemCounter++;
  ...
  if (i<MAX_BSEM){
    binSemaphore[i].id = binSemCounter;
     954:	8d 98 c0 22 00 00    	lea    0x22c0(%eax),%ebx
     95a:	89 90 c4 22 00 00    	mov    %edx,0x22c4(%eax)
    binSemCounter++;
     960:	83 c2 01             	add    $0x1,%edx
     963:	89 15 7c 19 00 00    	mov    %edx,0x197c
    binSemaphore[i].lock = 1; // not locked
     969:	c7 80 c0 22 00 00 01 	movl   $0x1,0x22c0(%eax)
     970:	00 00 00 
    binSemaphore[i].state = USED;
     973:	c7 80 c8 23 00 00 00 	movl   $0x0,0x23c8(%eax)
     97a:	00 00 00 
    // printf(1,"initialize semaphore in index %d, with id %d\n",i,binSemCounter-1);
    alarm(UTHREAD_QUANTA);
    ...
    printf(1,"all semaphores are being used\n");
     ...
     990:	68 4c 12 00 00       	push   $0x124c
     995:	6a 01                	push   $0x1
...
void bsem_free(int id) {
  ...
  alarm(0);
     ...
     9d1:	ba c4 22 00 00       	mov    $0x22c4,%edx
  ...
  for(i = 0; i <MAX_BSEM; i++) {
    ...
    if(binSemaphore[i].id == id) {
     ...
     9fa:	05 c0 22 00 00       	add    $0x22c0,%eax
  ...
  printf(1,"can't find id %d\n",id);
     ...
     a2b:	53                   	push   %ebx
     a2c:	68 a8 13 00 00       	push   $0x13a8
     a31:	6a 01                	push   $0x1
...
void bsem_down(int id) {
  ...
  alarm(0);
     ...
     a61:	b8 c4 22 00 00       	mov    $0x22c4,%eax
  ...
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 1) { //if lock not taken
     ...
     a9a:	83 b9 c0 22 00 00 01 	cmpl   $0x1,0x22c0(%ecx)
  ...
  //  printf(1, "lock is already taken - thread %d going to sleep on binary semaphore with id %d\n",threads[index_currently_running].thread_id, id);
	for (int j=0;j<MAX_UTHREADS;j++){
     ...
     ab8:	83 bc 81 c8 22 00 00 	cmpl   $0xffffffff,0x22c8(%ecx,%eax,4)
     abf:	ff 
     ac0:	75 ee                	jne    ab0 <bsem_down+0x60>
      binSemaphore[i].sleep[j] = threads[index_currently_running].thread_id;
     ac2:	8b 0d c8 a8 00 00    	mov    0xa8c8,%ecx
     ac8:	6b d2 43             	imul   $0x43,%edx,%edx
     acb:	01 c2                	add    %eax,%edx
     acd:	8d 04 c9             	lea    (%ecx,%ecx,8),%eax
     ad0:	8b 04 85 a0 19 00 00 	mov    0x19a0(,%eax,4),%eax
     ad7:	89 04 95 c8 22 00 00 	mov    %eax,0x22c8(,%edx,4)
	  break;
	  }
    }
  //  printf(1,"zZzzZzzzZzzz.....\n");
     ...
     ae1:	c7 04 85 a8 19 00 00 	movl   $0x4,0x19a8(,%eax,4)
     ae8:	04 00 00 00 
...
printf(1,"you tried to lock a binary semaphore that does not exist! (id: %d)\n", id);
     ...
     b13:	53                   	push   %ebx
     b14:	68 6c 12 00 00       	push   $0x126c
     b19:	6a 01                	push   $0x1
...
alarm(UTHREAD_QUANTA);
     ...
     b33:	8b 0d c8 a8 00 00    	mov    0xa8c8,%ecx
  ...
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 1) { //if lock not taken
      // printf(1, "thread %d got lock for binary semaphore with id %d \n",threads[index_currently_running].thread_id, id);
      binSemaphore[i].lock=0;
     b3b:	c7 81 c0 22 00 00 00 	movl   $0x0,0x22c0(%ecx)
     b42:	00 00 00 
...
void bsem_up(int id) {
  ...
  alarm(0);
     ...
     b73:	ba c4 22 00 00       	mov    $0x22c4,%edx
  ...
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 0) { //lock is taken
     ...
     ba8:	8b 97 c0 22 00 00    	mov    0x22c0(%edi),%edx
     ...
     bbe:	8b b4 be c8 22 00 00 	mov    0x22c8(%esi,%edi,4),%esi
     bc5:	83 fe ff             	cmp    $0xffffffff,%esi
     bc8:	74 56                	je     c20 <bsem_up+0xc0>
     bca:	b9 a0 19 00 00       	mov    $0x19a0,%ecx
     ...
     bf4:	c7 04 95 a8 19 00 00 	movl   $0x2,0x19a8(,%edx,4)
     bfb:	02 00 00 00 
              binSemaphore[i].sleep[j] =- 1;
     bff:	01 c7                	add    %eax,%edi
     c01:	c7 04 bd c8 22 00 00 	movl   $0xffffffff,0x22c8(,%edi,4)
     c08:	ff ff ff ff 
    }
  }
  /* didnt found */
  ...
  if (i<MAX_BSEM){
    if(binSemaphore[i].lock == 0) { //lock is taken
     ...
     c2e:	c7 80 c0 22 00 00 01 	movl   $0x1,0x22c0(%eax)
     c35:	00 00 00 
  ...
  /* didnt found */
    ...
    printf(1,"you tried to free a binary semaphore that does not exist! (id: %d)\n", id);
     ...
     c43:	53                   	push   %ebx
     c44:	68 d4 12 00 00       	push   $0x12d4
     c49:	6a 01                	push   $0x1
     ...
     c58:	68 b0 12 00 00       	push   $0x12b0
     c5d:	6a 01                	push   $0x1
...
uthread_init()
{
  ...
  printf(1, "-------initializing the threads -------\n");
     c76:	68 18 13 00 00       	push   $0x1318
     c7b:	6a 01                	push   $0x1
     c7d:	e8 8e f7 ff ff       	call   410 <printf>
     c82:	b8 a0 19 00 00       	mov    $0x19a0,%eax
...
uthread_init()
{
  ...
  // Initializes the process’ threads table
  for(int i = 0 ; i < MAX_UTHREADS ; i++)
     cbc:	3d a0 22 00 00       	cmp    $0x22a0,%eax
  ...
  threads[0].thread_id = 0;
     cc6:	c7 05 a0 19 00 00 00 	movl   $0x0,0x19a0
     ccd:	00 00 00 
  threads[0].state = RUNNING_THREAD;
     cd0:	c7 05 a8 19 00 00 03 	movl   $0x3,0x19a8
     cd7:	00 00 00 
  ...
  threads[0].state = RUNNING_THREAD;
  threads[0].stack = 0;
     ce1:	c7 05 a4 19 00 00 00 	movl   $0x0,0x19a4
     ce8:	00 00 00 

  id_number_thread = 1;
     ceb:	c7 05 c4 a8 00 00 01 	movl   $0x1,0xa8c4
     cf2:	00 00 00 
  index_currently_running = 0;
     cf5:	c7 05 c8 a8 00 00 00 	movl   $0x0,0xa8c8
     cfc:	00 00 00 
  currently_running = 0;
     cff:	c7 05 a0 22 00 00 00 	movl   $0x0,0x22a0
     d06:	00 00 00 
  // Registers the SIGALRM handler to the uthread_schedule function
  signal(14,  (sighandler_t)(uthread_schedule));
...
uthread_create(void (*start_func)(void *), void*arg)
{
  ...
  printf(1, "------ creating a new thread ------\n");
     d2f:	5b                   	pop    %ebx
     d30:	5e                   	pop    %esi
     d31:	68 44 13 00 00       	push   $0x1344
     d36:	6a 01                	push   $0x1
     d38:	e8 d3 f6 ff ff       	call   410 <printf>
     d3d:	ba a8 19 00 00       	mov    $0x19a8,%edx
  ...
  threads[free_thread].thread_id = id_number_thread;
     d61:	8b 15 c4 a8 00 00    	mov    0xa8c4,%edx
  ...
  threads[free_thread].thread_id = id_number_thread;
     ...
     d75:	89 93 a0 19 00 00    	mov    %edx,0x19a0(%ebx)
  id_number_thread++;
     d7b:	83 c2 01             	add    $0x1,%edx
     d7e:	89 15 c4 a8 00 00    	mov    %edx,0xa8c4
  ...
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 3*sizeof(int))) = (int)uthread_exit;
  ...
  /* creating the stack */
  threads[free_thread].stack = malloc(UTHREAD_STACK_SIZE);
     d96:	89 83 a4 19 00 00    	mov    %eax,0x19a4(%ebx)
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 3*sizeof(int))) = (int)uthread_exit;
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - 2*sizeof(int))) = (int)start_func;
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - sizeof(int))) = (int)arg;
  ...
  threads[free_thread].state = RUNNABLE_THREAD;
     d9c:	c7 83 a8 19 00 00 02 	movl   $0x2,0x19a8(%ebx)
     da3:	00 00 00 
  /* creating the stack */
  threads[free_thread].stack = malloc(UTHREAD_STACK_SIZE);
  ...
  *((int*)(threads[free_thread].stack + UTHREAD_STACK_SIZE - sizeof(int))) = (int)arg;
  ...
  return   threads[free_thread].thread_id;
     dc1:	8b 83 a0 19 00 00    	mov    0x19a0(%ebx),%eax
  ...
  if(free_thread == -1){
    printf(1, "there is no available thread\n");
     ...
     ddb:	68 ba 13 00 00       	push   $0x13ba
     de0:	6a 01                	push   $0x1
 ...
 // printf(1, "prev state is : %d next state is : %d\n", (int)(threads[prev_index].state), (int)(threads[next].state));
  ...
  if (prev_index!=0 ){
    ...
    asm("movl %%esp, %0;" : "=r" (threads[prev_index].esp));
     ...
     e1f:	8d 04 85 a0 19 00 00 	lea    0x19a0(,%eax,4),%eax
  ...
  threads[index_currently_running].state = RUNNING_THREAD;
     e2e:	a1 c8 a8 00 00       	mov    0xa8c8,%eax
     e33:	8d 04 c0             	lea    (%eax,%eax,8),%eax
     e36:	8d 04 85 a0 19 00 00 	lea    0x19a0(,%eax,4),%eax
...
//  printf(1, "------ scheduleing ------\n");
  ...
  if (threads[index_currently_running].state == RUNNING_THREAD && index_currently_running!=0){
     e82:	a1 c8 a8 00 00       	mov    0xa8c8,%eax
     e87:	83 c4 10             	add    $0x10,%esp
     e8a:	8d 14 c0             	lea    (%eax,%eax,8),%edx
     e8d:	8d 14 95 a0 19 00 00 	lea    0x19a0(,%edx,4),%edx
  ...
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
    ...
    if(threads[i].state == SLEEPING_THREAD && threads[i].join!= -1 && threads[threads[i].join].state == UNUSED_THREAD) {
     ...
     ed6:	8b 14 95 a8 19 00 00 	mov    0x19a8(,%edx,4),%edx
     ...
     ee8:	68 6c 13 00 00       	push   $0x136c
     eed:	6a 01                	push   $0x1
  ...
  for(int i = 0 ; i < MAX_UTHREADS ; i++){
     f05:	81 fb a8 22 00 00    	cmp    $0x22a8,%ebx
  ...
  int prev_index = index_currently_running;
     f10:	8b 15 c8 a8 00 00    	mov    0xa8c8,%edx
  int check=1;
  for (int i=prev_index+1;check<=MAX_UTHREADS;i++) {
    ...
    if(threads[i].state == RUNNABLE_THREAD && i!=prev_index){
     f3a:	83 3c 9d a8 19 00 00 	cmpl   $0x2,0x19a8(,%ebx,4)
     f41:	02 
     ...
     f48:	a3 c8 a8 00 00       	mov    %eax,0xa8c8
  ...
  if (threads[index_currently_running].state != RUNNABLE_THREAD )
     fa3:	83 3c 85 a8 19 00 00 	cmpl   $0x2,0x19a8(,%eax,4)
     faa:	02 
...
uthread_self()
{
  return threads[index_currently_running].thread_id;
     fc0:	a1 c8 a8 00 00       	mov    0xa8c8,%eax
  exit();
}
...
{
  return threads[index_currently_running].thread_id;
     fcc:	8b 04 85 a0 19 00 00 	mov    0x19a0(,%eax,4),%eax
}
     fd3:	c3                   	ret    
...
uthread_join(int tid)
{
  ...
  if(tid > id_number_thread || tid < 0){ // checking if the tid is relevent
     fe8:	39 35 c4 a8 00 00    	cmp    %esi,0xa8c4
...
uthread_join(int tid)
{
  ...
  alarm(0);
    ...
    100d:	b8 a0 19 00 00       	mov    $0x19a0,%eax
  ...
  /* there is a process with this tid*/
    ...
    1036:	53                   	push   %ebx
    1037:	ff 35 c8 a8 00 00    	pushl  0xa8c8
    103d:	68 f6 13 00 00       	push   $0x13f6
    1042:	6a 01                	push   $0x1
    1044:	e8 c7 f3 ff ff       	call   410 <printf>
    threads[index_currently_running].join=found_tid;
    1049:	a1 c8 a8 00 00       	mov    0xa8c8,%eax
    104e:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    1051:	8d 04 85 a0 19 00 00 	lea    0x19a0(,%eax,4),%eax
  ...
  if(found_tid == -1) {
    ...
    1083:	56                   	push   %esi
    1084:	68 d8 13 00 00       	push   $0x13d8
    1089:	6a 01                	push   $0x1
...
uthread_sleep(int ticks)
{
  ...
  threads[index_currently_running].time_to_get_up = uptime()+ticks;
    10be:	8b 1d c8 a8 00 00    	mov    0xa8c8,%ebx
    10c4:	e8 71 f2 ff ff       	call   33a <uptime>
    10c9:	03 45 08             	add    0x8(%ebp),%eax
    10cc:	8d 14 db             	lea    (%ebx,%ebx,8),%edx
    10cf:	89 04 95 bc 19 00 00 	mov    %eax,0x19bc(,%edx,4)
  threads[index_currently_running].state = SLEEPING_THREAD;
    10d6:	a1 c8 a8 00 00       	mov    0xa8c8,%eax
    10db:	8d 04 c0             	lea    (%eax,%eax,8),%eax
    10de:	c7 04 85 a8 19 00 00 	movl   $0x1,0x19a8(,%eax,4)
    10e5:	01 00 00 00 
